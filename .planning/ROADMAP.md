...
- [ ] **Phase 8: Observability & APK Distribution Hardening** - Firebase Analytics funnel, Crashlytics, structured CloudWatch logs, Bull-Board hash-verify dashboard, signed-APK distribution pipeline production-hardened (iOS parity + staged Play Store / App Store rollout deferred — see REQUIREMENTS.md §v2) (renumbered from Phase 7 2026-05-24 — content unchanged)

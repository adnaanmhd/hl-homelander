...
| T-2.22-03 | Spoofing  | Crashlytics opt-out via injected meta-data on a tampered build                                                                                        | accept      | Build flavor + signing key gate this; out of scope for Phase 2 manifest-level gates. Phase 7 staged rollout enforces signed Play Store builds.                                                               |

...
- **D-09:** **`HumynBeep` SoundPool tones + `Vibrator` haptics restoration** is **Wave 1** of Phase 6, before any new Tasks/Home/History work (mirrors Phase 5 Wave 1 = `04-COSMETIC-GAPS.md` cleanup). Scope:
...
- **Wave-1-first cleanup** (Phase 3 + Phase 5) — Phase 6 Wave 1 = the `HumynBeep` SoundPool / Vibrator restore (D-09), then the new feature waves.
...
- **Phase 5 carry-over folded as Wave 1.** Per ROADMAP carry-over; mirrors Phase 3/5's Wave-1-first cleanup pattern. Audibility/haptic restore is observability not a capture-spec issue.

...
| T-3.10-09 | Information disclosure | Source-map exposure of CaptureSession + FinalizeWorker via APK reverse-engineering | accept | apkRollout flavor is signed but not obfuscated — same trust model as Phase 1/2. Production-grade ProGuard / R8 obfuscation is a Phase 8 hardening concern. |

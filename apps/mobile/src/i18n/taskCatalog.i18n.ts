...
export const TASK_CATALOG_I18N: Record<string, Record<Locale, TaskBody>> = {
  'Cooking a meal': {
    ...
    'pt-BR': {
      ...
      description:
        'Faça uma refeição completa do início ao fim. Isso pode incluir lavar, cortar, cozinhar no fogão e colocar a comida nos pratos.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Prepara una comida completa de principio a fin. Esto puede incluir lavar, cortar, cocinar en la estufa y servir la comida en los platos.',
      instructions: [
    ...
    'hi-IN': {
      name: 'खाना पकाना',
      description:
        'शुरू से आख़िर तक पूरा खाना बनाएँ। इसमें धोना, काटना, गैस पर पकाना और प्लेट में परोसना शामिल हो सकता है।',
      instructions: [
    ...
    'bn-IN': {
      name: 'রান্না করা',
      description:
        'শুরু থেকে শেষ পর্যন্ত একটা পুরো খাবার বানান। এতে ধোয়া, কাটা, গ্যাসে রান্না করা আর প্লেটে খাবার সাজানো সব থাকতে পারে।',
      instructions: [
    ...
    'ta-IN': {
      ...
      description:
        'ஆரம்பம் முதல் முடிவு வரை ஒரு முழு சாப்பாடு தயாரிக்கவும். கழுவுதல், நறுக்குதல், அடுப்பில் சமைத்தல், தட்டில் பரிமாறுதல் ஆகியவற்றை உள்ளடக்கலாம்.',
      instructions: [
    ...
    'te-IN': {
      name: 'భోజనం వండడం',
      description:
        'మొదటి నుండి చివరి వరకు పూర్తి భోజనం తయారు చేయండి. ఇందులో కడగడం, తరగడం, పొయ్యి మీద వండడం, ఆహారాన్ని ప్లేట్లలో పెట్టడం ఉంటాయి.',
      instructions: [
    ...
    'mr-IN': {
      name: 'जेवण बनवणे',
      description:
        'सुरुवातीपासून शेवटपर्यंत पूर्ण जेवण तयार करा. यात धुणे, कापणे, गॅसवर शिजवणे आणि ताटात वाढणे यांचा समावेश असू शकतो.',
      instructions: [
  ...
  Chopping: {
    ...
    'pt-BR': {
      name: 'Picar',
      description:
        'Use uma faca para cortar a comida em pedaços pequenos sobre uma tábua. Faça os pedaços do tamanho que você precisa.',
      instructions: [
    ...
    es: {
      name: 'Picar',
      description:
        'Usa un cuchillo para cortar la comida en trozos pequeños sobre una tabla de picar. Haz los trozos del tamaño que necesites.',
      instructions: [
    ...
    'hi-IN': {
      name: 'काटना',
      description:
        'चाकू से खाने को चॉपिंग बोर्ड पर छोटे-छोटे टुकड़ों में काटें। जितने बड़े टुकड़े चाहिए, उतने ही काटें।',
      instructions: ['चॉपिंग बोर्ड की ओर नीचे देखें।', 'सिर को धीरे-धीरे और हल्के से घुमाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'কুচি করা',
      description:
        'ছুরি দিয়ে কাটিং বোর্ডে খাবার ছোট ছোট টুকরো করে কাটুন। যে মাপে দরকার সেই মাপে টুকরো করুন।',
      instructions: ['কাটিং বোর্ডের দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'நறுக்குவது',
      description:
        'கட்டிங் போர்டில் கத்தியை வைத்து உணவை சிறிய துண்டுகளாக நறுக்குங்கள். உங்களுக்கு தேவையான அளவில் துண்டுகளை செய்யுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      name: 'తరగడం',
      description:
        'కటింగ్ బోర్డ్ మీద ఆహారాన్ని చిన్న ముక్కలుగా కత్తితో తరగండి. మీకు కావలసిన పరిమాణంలో ముక్కలు చేయండి.',
      instructions: ['కటింగ్ బోర్డ్ వైపు కిందికి చూడండి.', 'చిన్నగా, మెల్లగా తల తిప్పండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'कापणे',
      description:
        'चॉपिंग बोर्डवर सुरीने अन्न लहान तुकड्यांत कापा. तुम्हाला हवे त्या आकाराचे तुकडे करा.',
      instructions: ['चॉपिंग बोर्डकडे खाली पाहा.', 'डोके हळूहळू, छोट्या हालचालींनी फिरवा.'],
      examples: [],
    },
  },
  Dicing: {
    ...
    'pt-BR': {
      ...
      description:
        'Use uma faca para cortar a comida em cubinhos pequenos e iguais sobre uma tábua.',
      instructions: [
        'Olhe para baixo, para a tábua.',
        'Faça movimentos suaves e pequenos com a cabeça.',
      ],
    ...
    es: {
      ...
      description:
        'Usa un cuchillo para cortar la comida en cubitos pequeños y parejos sobre una tabla de picar.',
      instructions: [
        'Mira hacia abajo, a la tabla de picar.',
        'Haz giros de cabeza pequeños y suaves.',
      ],
    ...
    'ta-IN': {
      ...
      description:
        'கட்டிங் போர்டில் கத்தியை வைத்து உணவை சிறிய, சம அளவிலான சதுர துண்டுகளாக நறுக்குங்கள்.',
      instructions: [
        'கட்டிங் போர்டை கீழே பாருங்கள்.',
        'தலையை மெதுவாக, சிறிய அசைவுகளில் திருப்புங்கள்.',
      ],
  ...
  Slicing: {
    ...
    es: {
      ...
      description:
        'Usa un cuchillo para cortar la comida en trozos finos y planos sobre una tabla de picar.',
      instructions: [
        'Mira hacia abajo, a la tabla de picar.',
        'Haz giros de cabeza pequeños y suaves.',
      ],
  ...
  Peeling: {
    ...
    es: {
      ...
      instructions: ['Mira hacia abajo, a tus manos.', 'Haz giros de cabeza pequeños y suaves.'],
      examples: [],
    },
    'hi-IN': {
      name: 'छिलका उतारना',
      description: 'पीलर या चाकू से फलों या सब्ज़ियों का ऊपरी छिलका उतारें।',
      instructions: ['अपने हाथों की ओर नीचे देखें।', 'सिर को धीरे-धीरे और हल्के से घुमाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'খোসা ছাড়ানো',
      description: 'পিলার বা ছুরি দিয়ে ফল বা সবজির খোসা ছাড়ান।',
      instructions: ['নিজের হাতের দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'தோல் சீவுவது',
      description:
        'பழங்கள் அல்லது காய்கறிகளின் வெளி தோலை பீலர் அல்லது கத்தியை வைத்து சீவி எடுக்கவும்.',
      instructions: [
    ...
    'te-IN': {
      ...
      instructions: ['మీ చేతుల వైపు కిందికి చూడండి.', 'చిన్నగా, మెల్లగా తల తిప్పండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'सालं काढणे',
      description: 'फळं किंवा भाज्यांची वरची सालं पीलर किंवा सुरीने काढा.',
      instructions: ['तुमच्या हातांकडे खाली पाहा.', 'डोके हळूहळू, छोट्या हालचालींनी फिरवा.'],
      examples: [],
    },
  },
  'Kneading or rolling dough': {
    ...
    'pt-BR': {
      ...
      description:
        'Aperte, dobre e empurre a massa com as mãos. Use um rolo para abrir a massa, se precisar.',
      instructions: ['Olhe para baixo, para a massa.', 'Mantenha as mãos em movimento — não pare.'],
      examples: [],
    },
    es: {
      name: 'Amasar o estirar masa',
      description:
        'Aprieta, dobla y empuja la masa con las manos. Usa un rodillo para aplanarla si hace falta.',
      instructions: ['Mira hacia abajo, a la masa.', 'Mantén las manos en movimiento, no pares.'],
      examples: [],
    },
    'hi-IN': {
      name: 'आटा गूँथना या बेलना',
      description: 'हाथों से आटे को दबाएँ, मोड़ें और गूँथें। ज़रूरत हो तो बेलन से इसे चपटा करें।',
      instructions: ['आटे की ओर नीचे देखें।', 'हाथ चलाते रहें — रुकें नहीं।'],
      examples: [],
    },
    'bn-IN': {
      name: 'ময়দা মাখা বা বেলা',
      description:
        'হাত দিয়ে ময়দা চেপে, ভাঁজ করে, ঠেলে মাখুন। দরকার হলে বেলন দিয়ে চ্যাপ্টা করুন।',
      instructions: ['ময়দার দিকে তাকান।', 'হাত চালিয়ে যান — থামবেন না।'],
      examples: [],
    },
    'ta-IN': {
      name: 'மாவு பிசைதல் அல்லது தேய்த்தல்',
      description:
        'கைகளால் மாவை அழுத்தி, மடித்து, தள்ளி பிசைந்து கொள்ளுங்கள். தேவைப்பட்டால் கிலி (உருளைக்கட்டை) வைத்து தேய்த்து தட்டையாக்குங்கள்.',
      instructions: ['மாவை கீழே பாருங்கள்.', 'கைகளை அசைத்துக்கொண்டே இருங்கள் — நிறுத்த வேண்டாம்.'],
      examples: [],
    },
    'te-IN': {
      name: 'పిండి కలపడం లేదా చపాతీ ఒత్తడం',
      description:
        'చేతులతో పిండిని నొక్కండి, మడతపెట్టండి, తోయండి. అవసరమైతే చపాతీ కర్రతో పల్చగా ఒత్తండి.',
      instructions: ['పిండి వైపు కిందికి చూడండి.', 'చేతులు కదుపుతూ ఉండండి — ఆగకండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'कणीक मळणे किंवा लाटणे',
      description: 'हातांनी कणीक दाबा, घडी करा आणि ढकला. लागल्यास लाटण्याने ती चपटी करा.',
      instructions: ['कणकेकडे खाली पाहा.', 'हात सतत चालू ठेवा — थांबू नका.'],
      examples: [],
    },
  },
  'Plating or serving food/drinks': {
    ...
    'pt-BR': {
      ...
      description:
        'Passe a comida pronta ou as bebidas das panelas e frigideiras para pratos, tigelas ou copos.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Pasa la comida cocida o las bebidas de las ollas y sartenes a los platos, tazones o vasos para comer.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'पके हुए खाने या पेय को बर्तनों और कढ़ाई से निकालकर प्लेट, कटोरी या गिलास में डालें ताकि खाया जा सके।',
      instructions: [
    ...
    'bn-IN': {
      ...
      description:
        'রান্না করা খাবার বা পানীয় হাঁড়ি-কড়াই থেকে প্লেট, বাটি বা গ্লাসে তুলুন খাওয়ার জন্য।',
      instructions: ['যা পরিবেশন করছেন সেদিকে তাকান।', 'একটার পর একটা জিনিস মসৃণভাবে নিন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'உணவு/பானங்களை தட்டில் வைத்து பரிமாறுவது',
      description:
        'சமைத்த உணவை அல்லது பானங்களை பாத்திரம், பான்களில் இருந்து தட்டு, கிண்ணம் அல்லது கிளாஸுக்கு மாற்றி உண்பதற்கு தயார் செய்யுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'వండిన ఆహారం లేదా పానీయాలను గిన్నెల నుండి ప్లేట్లు, బౌల్స్ లేదా గ్లాసుల్లోకి తినడానికి సిద్ధం చేయండి.',
      instructions: [
  ...
  'Packing food': {
    ...
    'pt-BR': {
      ...
      instructions: ['Olhe para baixo, para a comida e o pote.', 'Continue embalando — não pare.'],
      examples: [],
    },
    es: {
      name: 'Empacar comida',
    ...
    'hi-IN': {
      ...
      instructions: ['खाने और डिब्बे की ओर नीचे देखें।', 'पैक करते रहें — रुकें नहीं।'],
      examples: [],
    },
    'bn-IN': {
      name: 'খাবার প্যাক করা',
      description: 'খাবার বাক্স, কৌটো বা ব্যাগে ভরুন যাতে নিয়ে যাওয়া বা রাখা যায়।',
      instructions: ['খাবার আর কৌটোর দিকে তাকান।', 'প্যাকিং চালিয়ে যান — থামবেন না।'],
      examples: [],
    },
    'ta-IN': {
      name: 'உணவு பேக் செய்வது',
      description:
        'உணவை டப்பாக்கள், டப்பிகள் அல்லது பைகளில் வைத்து எடுத்துச் செல்லவோ சேமிக்கவோ ஆயத்தம் செய்யுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'తీసుకెళ్లడానికి లేదా దాచడానికి ఆహారాన్ని డబ్బాలు, కంటైనర్లు లేదా బ్యాగ్‌లలో పెట్టండి.',
      instructions: ['ఆహారం మరియు డబ్బా వైపు కిందికి చూడండి.', 'ప్యాక్ చేస్తూ ఉండండి — ఆగకండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'अन्न डब्यात भरणे',
      description: 'अन्न डबे, कंटेनर किंवा पिशव्यांत भरा, जेणेकरून ते नेता किंवा साठवता येईल.',
      instructions: ['अन्न आणि डब्याकडे खाली पाहा.', 'भरणे चालू ठेवा — थांबू नका.'],
      examples: [],
    },
  },
  'Brewing drip coffee': {
    ...
    'pt-BR': {
      ...
      description:
        'Encha a cafeteira com água, coloque o pó no filtro e ligue a máquina para fazer uma jarra de café.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Llena la cafetera con agua, pon café molido en el filtro y enciende la máquina para preparar una jarra.',
      instructions: ['Mira la máquina mientras trabajas.', 'Muévete con suavidad entre los pasos.'],
      examples: [],
    },
    'hi-IN': {
      name: 'ड्रिप कॉफ़ी बनाना',
      description:
        'कॉफ़ी मेकर में पानी भरें, फ़िल्टर की टोकरी में पिसी कॉफ़ी डालें, और मशीन चालू करके कॉफ़ी बनाएँ।',
      instructions: ['काम करते समय मशीन की ओर देखें।', 'हर कदम आराम से बढ़ाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'ড্রিপ কফি বানানো',
      description:
        'কফি মেশিনে জল ভরুন, ফিল্টারে কফির গুঁড়ো দিন, আর মেশিন চালু করে এক পট কফি বানান।',
      instructions: ['কাজ করার সময় মেশিনের দিকে তাকান।', 'ধাপগুলোর মাঝে মসৃণভাবে এগোন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'டிரிப் காபி போடுவது',
      description:
        'காபி மெஷினில் தண்ணீர் ஊற்றி, ஃபில்டர் கூடையில் பொடி காபியை போட்டு, மெஷினை இயக்கி காபி தயார் செய்யுங்கள்.',
      instructions: ['வேலை செய்யும்போது மெஷினை பாருங்கள்.', 'ஒவ்வொரு படியிலும் மெதுவாக நகருங்கள்.'],
      examples: [],
    },
    'te-IN': {
      name: 'డ్రిప్ కాఫీ తయారు చేయడం',
      description:
        'కాఫీ మెషీన్‌లో నీళ్లు నింపండి, ఫిల్టర్ బాస్కెట్‌లో కాఫీ పొడి వేయండి, మెషీన్ ఆన్ చేసి కాఫీ తయారు చేయండి.',
      instructions: ['పని చేస్తున్నప్పుడు మెషీన్ వైపు చూడండి.', 'ప్రతి అడుగు మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'ड्रिप कॉफी बनवणे',
      description:
        'कॉफी मशीनमध्ये पाणी भरा, फिल्टरमध्ये कॉफी पावडर टाका आणि कॉफी तयार करण्यासाठी मशीन चालू करा.',
      instructions: ['काम करताना मशीनकडे पाहा.', 'एका टप्प्यातून दुसऱ्या टप्प्यात सहज जा.'],
      examples: [],
    },
  },
  'Brewing single-cup coffee (pod machine)': {
    ...
    'pt-BR': {
      ...
      description:
        'Coloque uma cápsula de café na máquina, ponha uma xícara embaixo do bico e aperte o botão para tirar uma xícara.',
      instructions: ['Olhe para a máquina enquanto trabalha.', 'Mova-se devagar entre as etapas.'],
      examples: [],
    },
    es: {
      name: 'Hacer café de una taza (máquina de cápsulas)',
      description:
        'Coloca una cápsula de café en una cafetera de una taza, pon una taza debajo del pico y aprieta el botón para preparar una taza.',
      instructions: ['Mira la máquina mientras trabajas.', 'Muévete despacio entre los pasos.'],
      examples: [],
    },
    'hi-IN': {
      name: 'एक कप कॉफ़ी बनाना (पॉड मशीन)',
      description:
        'सिंगल-कप ब्रूअर में कॉफ़ी पॉड डालें, नीचे मग रखें, और बटन दबाकर एक कप कॉफ़ी बनाएँ।',
      instructions: ['काम करते समय मशीन की ओर देखें।', 'हर कदम धीरे-धीरे बढ़ाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'এক কাপ কফি বানানো (পড মেশিন)',
      description:
        'একটা কফি পড সিঙ্গেল-কাপ মেশিনে রাখুন, নলের তলায় একটা মগ বসান, আর বোতাম টিপে এক কাপ কফি বানান।',
      instructions: ['কাজ করার সময় মেশিনের দিকে তাকান।', 'ধাপগুলোর মাঝে আস্তে এগোন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'ஒற்றை கப் காபி போடுவது (பாட் மெஷின்)',
      description:
        'ஒற்றை-கப் மெஷினில் ஒரு காபி பாட் வைத்து, கீழே ஒரு கப் வைத்து, பட்டனை அழுத்தி ஒரு கப் காபி தயார் செய்யுங்கள்.',
      instructions: ['வேலை செய்யும்போது மெஷினை பாருங்கள்.', 'ஒவ்வொரு படியிலும் மெதுவாக நகருங்கள்.'],
      examples: [],
    },
    'te-IN': {
      ...
      description:
        'ఒక కప్పు బ్రూవర్‌లో కాఫీ పాడ్ పెట్టండి, దాని కింద కప్పు పెట్టండి, బటన్ నొక్కి ఒక కప్పు కాఫీ తయారు చేయండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'सिंगल-कप मशीनमध्ये कॉफी पॉड ठेवा, खाली कप ठेवा आणि एक कप कॉफी बनवण्यासाठी बटण दाबा.',
      instructions: ['काम करताना मशीनकडे पाहा.', 'टप्प्यांमध्ये हळूहळू हालचाल करा.'],
      examples: [],
    },
  },
  'Grilling on a BBQ': {
    ...
    'pt-BR': {
      ...
      description:
        'Acenda a churrasqueira, coloque a comida na grelha e use o pegador ou a espátula para virar e conferir até ficar pronta.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Enciende la parrilla, coloca la comida sobre las rejillas y usa pinzas o una espátula para voltearla y revisarla hasta que esté cocida.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'बीबीक्यू ग्रिल जलाएँ, खाने को जाली पर रखें, और चिमटे या पलटे से उसे पलटें और जाँचें जब तक वह पक न जाए।',
      instructions: ['पकाते समय ग्रिल की ओर देखें।', 'पलटने और जाँचने के बीच आराम से चलें।'],
      examples: [],
    },
    'bn-IN': {
      name: 'বার্বিকিউতে গ্রিল করা',
      description:
        'বার্বিকিউ গ্রিল জ্বালান, খাবার গ্রেটে রাখুন, আর সাঁড়াশি বা হাতা দিয়ে উল্টে-পাল্টে দেখুন যতক্ষণ না রান্না হয়।',
      instructions: ['রান্নার সময় গ্রিলের দিকে তাকান।', 'উল্টানো আর দেখার সময় মসৃণভাবে নাড়ুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'பார்பிக்யூவில் கிரில் செய்வது',
      description:
        'பார்பிக்யூ கிரில்லை பற்றவைத்து, கிரில் கம்பிகள் மேல் உணவை வையுங்கள், இடுக்கி அல்லது மேலாள் கரண்டியால் புரட்டி, சரியாக வெந்ததா என பார்த்து சமையுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'BBQ గ్రిల్‌ను వెలిగించండి, దాని మీద ఆహారం పెట్టండి, టాంగ్స్ లేదా స్పాట్యులాతో తిప్పుతూ వండండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'BBQ ग्रिल पेटवा, अन्न जाळीवर ठेवा आणि चिमटा किंवा स्पॅच्युलाने उलटून शिजेपर्यंत बघत राहा.',
      instructions: ['शिजवताना ग्रिलकडे पाहा.', 'उलटताना आणि तपासताना सहज हालचाल करा.'],
      examples: [],
    },
  },
  'Baking on a sheet pan': {
    ...
    'pt-BR': {
      ...
      description:
        'Arrume a comida na assadeira, leve ao forno e tire quando estiver pronta usando luvas de forno.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Acomoda la comida en una bandeja de horno, métela al horno y sácala cuando esté lista usando guantes de cocina.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'खाने को बेकिंग शीट पर सजाएँ, ओवन में रखें, और दस्ताने पहनकर बनने के बाद उसे निकालें।',
      instructions: [
    ...
    'bn-IN': {
      ...
      description:
        'একটা বেকিং শিটে খাবার সাজান, ওভেনে ঢোকান, আর হয়ে গেলে ওভেন মিট্ট পরে বের করুন।',
      instructions: [
    ...
    'ta-IN': {
      ...
      description:
        'உணவை ஒரு பேக்கிங் ஷீட் மீது அடுக்கி, ஓவனில் வையுங்கள், வெந்தபின் ஓவன் கையுறை அணிந்து எடுத்து விடுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'షీట్ ప్యాన్ మీద ఆహారాన్ని పేర్చండి, ఓవెన్‌లో పెట్టండి, ఓవెన్ మిట్స్ ఉపయోగించి తీయండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'बेकिंग शीटवर अन्न मांडा, ओव्हनमध्ये ठेवा आणि तयार झाल्यावर ओव्हन मिट्स वापरून बाहेर काढा.',
      instructions: [
  ...
  'Washing dishes': {
    ...
    'pt-BR': {
      name: 'Lavar a louça',
      description:
        'Limpe pratos, tigelas, copos e talheres usados com água e sabão. Enxágue bem e deixe de lado para secar.',
      instructions: ['Olhe para baixo, para a pia.', 'Continue trabalhando até terminar a pilha.'],
      examples: [],
    },
    es: {
      name: 'Lavar los platos',
      description:
        'Limpia los platos, tazones, vasos y cubiertos usados con jabón y agua. Enjuágalos bien y déjalos a un lado para que se sequen.',
      instructions: ['Mira hacia abajo, al fregadero.', 'Sigue trabajando con la pila de platos.'],
      examples: [],
    },
    'hi-IN': {
      name: 'बर्तन धोना',
      description:
        'गंदी प्लेट, कटोरी, गिलास और चम्मच को साबुन और पानी से साफ़ करें। अच्छे से धोएँ और सूखने के लिए एक ओर रखें।',
      instructions: ['सिंक की ओर नीचे देखें।', 'ढेर के सारे बर्तन धोते रहें।'],
      examples: [],
    },
    'bn-IN': {
      name: 'বাসন মাজা',
      description:
        'ব্যবহার করা প্লেট, বাটি, গ্লাস আর চামচ সাবান-জল দিয়ে ধুয়ে পরিষ্কার করুন। ভালো করে ধুয়ে শুকোতে রাখুন।',
      instructions: ['সিঙ্কের দিকে তাকান।', 'একটার পর একটা বাসন মাজতে থাকুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'பாத்திரம் கழுவுவது',
      description:
        'பயன்படுத்திய தட்டு, கிண்ணம், கிளாஸ், கரண்டிகளை சோப்பு மற்றும் தண்ணீரால் கழுவுங்கள். நன்றாக அலசி, காய வைப்பதற்காக ஒதுக்கி வையுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      name: 'గిన్నెలు కడగడం',
      description:
        'వాడిన ప్లేట్లు, బౌల్స్, గ్లాసులు, చెంచాలను సబ్బు, నీళ్లతో శుభ్రం చేయండి. బాగా జల్లి, ఆరడానికి పక్కన పెట్టండి.',
      instructions: ['సింక్ వైపు కిందికి చూడండి.', 'గిన్నెలు అన్నీ అయ్యేవరకు పని చేస్తూ ఉండండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'भांडी घासणे',
      description:
        'वापरलेली ताटं, वाट्या, ग्लास आणि चमचे साबण आणि पाण्याने स्वच्छ करा. नीट विसळा आणि वाळण्यासाठी बाजूला ठेवा.',
      instructions: ['सिंककडे खाली पाहा.', 'ढीगातील भांडी संपेपर्यंत काम चालू ठेवा.'],
      examples: [],
    },
  },
  'Drying or wiping dishes': {
    ...
    'pt-BR': {
      ...
      instructions: ['Olhe para baixo, para as suas mãos.', 'Continue enxugando — não pare.'],
      examples: [],
    },
    es: {
      name: 'Secar los platos',
      description:
        'Usa un paño limpio y seco para quitar el agua de los platos lavados y guardarlos.',
      instructions: ['Mira hacia abajo, a tus manos.', 'Sigue secando, no pares.'],
      examples: [],
    },
    'hi-IN': {
      name: 'बर्तन सुखाना या पोंछना',
      description: 'साफ़, सूखे कपड़े से धुले बर्तनों का पानी पोंछें और उन्हें जगह पर रखें।',
      instructions: ['अपने हाथों की ओर नीचे देखें।', 'पोंछते रहें — रुकें नहीं।'],
      examples: [],
    },
    'bn-IN': {
      name: 'বাসন মোছা বা শুকানো',
      description: 'ধোয়া বাসন থেকে একটা পরিষ্কার, শুকনো কাপড় দিয়ে জল মুছে নিয়ে রেখে দিন।',
      instructions: ['নিজের হাতের দিকে তাকান।', 'মুছতে থাকুন — থামবেন না।'],
      examples: [],
    },
    'ta-IN': {
      name: 'பாத்திரங்களை துடைப்பது அல்லது காய வைப்பது',
      description:
        'சுத்தமான, உலர்ந்த துணியால் கழுவிய பாத்திரங்களில் உள்ள தண்ணீரை துடைத்து, ஒதுக்கி வையுங்கள்.',
      instructions: [
        'உங்கள் கைகளை கீழே பாருங்கள்.',
    ...
    'te-IN': {
      ...
      instructions: ['మీ చేతుల వైపు కిందికి చూడండి.', 'తుడుస్తూ ఉండండి — ఆగకండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'भांडी पुसणे किंवा वाळवणे',
      description: 'स्वच्छ, कोरड्या फडक्याने धुतलेल्या भांड्यांवरील पाणी पुसून भांडी जागेवर ठेवा.',
      instructions: ['तुमच्या हातांकडे खाली पाहा.', 'पुसणे चालू ठेवा — थांबू नका.'],
      examples: [],
    },
  },
  'Loading a dishwasher': {
    ...
    'pt-BR': {
      ...
      description:
        'Coloque pratos, copos e talheres sujos nas prateleiras da lava-louças de forma organizada. Adicione o detergente e feche a porta.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Acomoda los platos, vasos y cubiertos sucios en las bandejas del lavavajillas de forma ordenada. Pon el detergente y cierra la puerta.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'गंदे बर्तन, गिलास और चम्मच को डिशवॉशर की रैक में करीने से लगाएँ। डिटर्जेंट डालें और दरवाज़ा बंद करें।',
      instructions: [
    ...
    'bn-IN': {
      ...
      description:
        'নোংরা বাসন, গ্লাস আর চামচ ডিশওয়াশারের র‍্যাকে গুছিয়ে রাখুন। সাবান দিয়ে দরজা বন্ধ করুন।',
      instructions: ['যে র‍্যাকে ভরছেন সেদিকে তাকান।', 'একটার পর একটা বাসন মসৃণভাবে রাখুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'டிஷ்வாஷரில் பாத்திரம் வைப்பது',
      description:
        'அழுக்கான தட்டு, கிளாஸ், கரண்டிகளை டிஷ்வாஷர் ரேக்குகளில் ஒழுங்காக அடுக்கி வையுங்கள். சோப்பு போட்டு கதவை மூடவும்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'మురికి ప్లేట్లు, గ్లాసులు, చెంచాలను డిష్‌వాషర్ ర్యాక్‌లలో క్రమంగా పెట్టండి. డిటర్జెంట్ వేసి తలుపు మూయండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'घाणेरडी भांडी, ग्लास आणि चमचे डिशवॉशरच्या रॅकमध्ये नीट लावा. साबण टाका आणि दार बंद करा.',
      instructions: [
  ...
  'Unloading a dishwasher': {
    ...
    'pt-BR': {
      ...
      description:
        'Tire as louças, copos e talheres limpos da lava-louças e guarde cada coisa no lugar certo nos armários ou gavetas.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Saca los platos, vasos y cubiertos limpios del lavavajillas y guarda cada cosa en su lugar, en las alacenas o los cajones.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'डिशवॉशर से साफ़ बर्तन, गिलास और चम्मच निकालें और हर चीज़ को उसकी सही जगह पर रखें — अलमारी या दराज़ में।',
      instructions: [
    ...
    'bn-IN': {
      ...
      description:
        'ডিশওয়াশার থেকে পরিষ্কার বাসন, গ্লাস আর চামচ বের করে আলমারি বা ড্রয়ারে নিজ নিজ জায়গায় রাখুন।',
      instructions: ['যে র‍্যাক থেকে বের করছেন সেদিকে তাকান।', 'একটার পর একটা মসৃণভাবে নিন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'டிஷ்வாஷரிலிருந்து பாத்திரம் எடுப்பது',
      description:
        'சுத்தமான தட்டு, கிளாஸ், கரண்டிகளை டிஷ்வாஷரில் இருந்து எடுத்து, ஒவ்வொன்றையும் அலமாரி அல்லது இழுப்பறையில் சரியான இடத்தில் வையுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'శుభ్రమైన ప్లేట్లు, గ్లాసులు, చెంచాలను డిష్‌వాషర్ నుండి తీసి, ప్రతి దాన్ని క్యాబినెట్లు లేదా అరల్లో దాని చోట పెట్టండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'डिशवॉशरमधून स्वच्छ भांडी, ग्लास आणि चमचे बाहेर काढा आणि प्रत्येक वस्तू कपाटात किंवा ड्रॉवरमध्ये योग्य जागी ठेवा.',
      instructions: [
  ...
  'Organizing kitchen cabinets or drawers': {
    ...
    'pt-BR': {
      ...
      description:
        'Tire as coisas dos armários ou gavetas, separe e coloque de volta de forma organizada.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Saca las cosas de las alacenas o cajones, ordénalas y vuelve a guardarlas de forma prolija.',
      instructions: ['Mira la alacena o el cajón.', 'Sigue moviendo cosas, no te quedes quieto.'],
      examples: [],
    },
    'hi-IN': {
      ...
      instructions: ['अलमारी या दराज़ की ओर देखें।', 'चीज़ें हटाते-रखते रहें — खाली खड़े न रहें।'],
      examples: [],
    },
    'bn-IN': {
    ...
    'ta-IN': {
      ...
      description:
        'அலமாரி அல்லது இழுப்பறையில் இருந்து பொருட்களை எடுத்து, வரிசைப்படுத்தி, ஒழுங்காக மீண்டும் வையுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'క్యాబినెట్లు లేదా అరల్లోంచి వస్తువులు తీసి, వర్గీకరించి, వాటిని తిరిగి నీట్‌గా పెట్టండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'कपाटातून किंवा ड्रॉवरमधून वस्तू बाहेर काढा, वेगवेगळ्या करा आणि नीट लावून परत ठेवा.',
      instructions: ['कपाट किंवा ड्रॉवरकडे पाहा.', 'वस्तू हलवत राहा — नुसते उभे राहू नका.'],
      examples: [],
    },
  },
  'Organizing spice rack': {
    ...
    'pt-BR': {
      ...
      description:
        'Arrume os potes e vidros de tempero no suporte ou na prateleira de forma organizada.',
      instructions: ['Olhe para o suporte enquanto arruma.', 'Mova-se com calma entre os potes.'],
      examples: [],
    },
    es: {
      name: 'Organizar el especiero',
      description:
        'Acomoda los frascos y botellas de especias en un estante o repisa de forma ordenada.',
      instructions: [
    ...
    'hi-IN': {
      ...
      instructions: ['सजाते समय रैक की ओर देखें।', 'एक डिब्बी से दूसरी डिब्बी तक आराम से जाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'মশলার র‍্যাক গোছানো',
      description: 'মশলার কৌটো আর বোতল র‍্যাক বা তাকে গুছিয়ে সাজান।',
      instructions: ['সাজানোর সময় র‍্যাকের দিকে তাকান।', 'একটার পর একটা কৌটো মসৃণভাবে নিন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'மசாலா ரேக்கை ஒழுங்காக்குவது',
      description:
        'மசாலா டப்பாக்கள் மற்றும் பாட்டில்களை ஒரு ரேக் அல்லது அலமாரியில் ஒழுங்காக அடுக்கி வையுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      instructions: ['అమర్చుతున్నప్పుడు ర్యాక్ వైపు చూడండి.', 'డబ్బాల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'मसाल्याचे रॅक लावणे',
      description: 'मसाल्याच्या बरण्या आणि बाटल्या रॅकवर किंवा फळीवर नीट क्रमाने लावा.',
      instructions: ['लावताना रॅककडे पाहा.', 'एका बरणीकडून दुसरीकडे सहज हालचाल करा.'],
      examples: [],
    },
  },
  'Setting a table': {
    ...
    es: {
      name: 'Poner la mesa',
      description:
        'Coloca los platos, vasos, cucharas, tenedores y servilletas en la mesa para una comida.',
      instructions: [
    ...
    'bn-IN': {
      ...
      instructions: ['জিনিস রাখার সময় টেবিলের দিকে তাকান।', 'একটার পর একটা জিনিস মসৃণভাবে রাখুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'மேசை அமைப்பது',
    ...
    'te-IN': {
      name: 'టేబుల్ సర్దడం',
      description:
        'భోజనం కోసం టేబుల్ మీద ప్లేట్లు, గ్లాసులు, చెంచాలు, ఫోర్క్‌లు, రుమాళ్లు పెట్టండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      instructions: ['वस्तू ठेवताना टेबलकडे खाली पाहा.', 'एका वस्तूकडून दुसरीकडे सहज हालचाल करा.'],
      examples: [],
    },
  },
  'Clearing a table': {
    ...
    'hi-IN': {
      ...
      instructions: ['मेज़ साफ़ करते समय नीचे देखें।', 'चीज़ें हटाते रहें — खाली खड़े न रहें।'],
      examples: [],
    },
    'bn-IN': {
    ...
    'ta-IN': {
      ...
      description:
        'சாப்பிட்டு முடிந்தபின் தட்டு, கிளாஸ், மீதி உணவு, குப்பைகளை மேசையில் இருந்து எடுத்து விடுங்கள்.',
      instructions: [
    ...
    'mr-IN': {
      ...
      instructions: ['आवरताना टेबलकडे खाली पाहा.', 'वस्तू हलवत राहा — नुसते उभे राहू नका.'],
      examples: [],
    },
  },
  'Organizing or stocking fridge': {
    ...
    'pt-BR': {
      ...
      description:
        'Coloque comida e bebidas dentro da geladeira de forma organizada. Mexa nos itens antigos e encaixe os novos.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Coloca la comida y las bebidas dentro del refrigerador de forma ordenada. Mueve lo viejo y haz espacio para lo nuevo.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'खाने-पीने की चीज़ें फ्रिज में करीने से रखें। पुरानी चीज़ें हटाएँ और नई चीज़ें अंदर रखें।',
      instructions: [
    ...
    'ta-IN': {
      ...
      description:
        'உணவு மற்றும் பானங்களை ஃபிரிட்ஜினுள் ஒழுங்காக வையுங்கள். பழைய பொருட்களை மாற்றி வைத்து, புதியதை உள்ளே அடுக்குங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'ఫ్రిజ్ లోపల ఆహారం, పానీయాలను నీట్‌గా పెట్టండి. పాత వస్తువులు సర్ది కొత్తవి అమర్చండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'फ्रिजमध्ये अन्न आणि पेयं नीट लावून ठेवा. जुन्या वस्तू बाजूला करून नवीन वस्तूंना जागा करा.',
      instructions: ['फ्रिज पूर्ण उघडा आणि आत पाहा.', 'वस्तू हलवत राहा — नुसते उभे राहू नका.'],
      examples: [],
    },
  },
  'Unpacking or sorting groceries': {
    ...
    'hi-IN': {
      ...
      instructions: ['थैलियों और सामान की ओर नीचे देखें।', 'सामान निकालते रहें — रुकें नहीं।'],
      examples: [],
    },
    'bn-IN': {
      ...
      instructions: ['ব্যাগ আর জিনিসের দিকে তাকান।', 'বের করতে থাকুন — থামবেন না।'],
      examples: [],
    },
    'ta-IN': {
      name: 'மளிகை சாமான்களை எடுத்து வரிசைப்படுத்துவது',
      description:
        'பைகளில் இருந்து மளிகை சாமான்களை எடுத்து வரிசைப்படுத்துங்கள். ஒவ்வொரு பொருளையும் சரியான இடத்தில் வையுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'బ్యాగుల్లోంచి సరుకులు తీసి వాటిని వర్గీకరించండి. ప్రతి దాన్ని దాని చోట పెట్టండి.',
      instructions: ['బ్యాగులు, వస్తువుల వైపు కిందికి చూడండి.', 'తీస్తూ ఉండండి — ఆగకండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'किराणा बाहेर काढणे किंवा वेगवेगळे करणे',
      description:
        'पिशव्यांमधून किराणा बाहेर काढा आणि वेगवेगळा करा. प्रत्येक वस्तू योग्य जागी ठेवा.',
      instructions: ['पिशव्या आणि वस्तूंकडे खाली पाहा.', 'बाहेर काढणे चालू ठेवा — थांबू नका.'],
      examples: [],
    },
  },
  'Using a garbage disposal': {
    ...
    'pt-BR': {
      ...
      description:
        'Empurre os restos de comida para o ralo da pia, abra a água fria e ligue o triturador para moer os resíduos.',
      instructions: ['Olhe para baixo, para a pia.', 'Mova-se devagar entre as etapas.'],
      examples: [],
    },
    es: {
      name: 'Usar el triturador de basura',
      description:
        'Raspa los restos de comida hacia el desagüe del fregadero, abre el agua fría y enciende el triturador para moler los desechos.',
      instructions: ['Mira hacia abajo, al fregadero.', 'Muévete despacio entre los pasos.'],
      examples: [],
    },
    'hi-IN': {
      name: 'गार्बेज डिस्पोज़ल इस्तेमाल करना',
      description:
        'खाने के टुकड़े सिंक के नाली में डालें, ठंडा पानी चलाएँ, और सिंक के नीचे लगे डिस्पोज़ल को चालू करके कचरे को पीसें।',
      instructions: ['सिंक की ओर नीचे देखें।', 'हर कदम धीरे-धीरे बढ़ाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'গার্বেজ ডিসপোজাল ব্যবহার করা',
      description:
        'খাবারের টুকরো সিঙ্কের ড্রেনে ফেলুন, ঠান্ডা জল ছাড়ুন, আর সিঙ্কের ভেতরের ডিসপোজাল চালু করে আবর্জনা গুঁড়ো করুন।',
      instructions: ['সিঙ্কের দিকে তাকান।', 'ধাপগুলোর মাঝে আস্তে এগোন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'கார்பேஜ் டிஸ்போஸல் பயன்படுத்துவது',
      description:
        'உணவு துண்டுகளை சிங்க் வடிகாலில் தள்ளி, குளிர்ந்த தண்ணீரை விட்டு, சிங்க்-உள் டிஸ்போஸலை இயக்கி கழிவை அரைக்கவும்.',
      instructions: ['சிங்கை கீழே பாருங்கள்.', 'ஒவ்வொரு படியிலும் மெதுவாக நகருங்கள்.'],
      examples: [],
    },
    'te-IN': {
      name: 'గార్బేజ్ డిస్పోజల్ ఉపయోగించడం',
      description:
        'మిగిలిన ఆహారాన్ని సింక్ డ్రెయిన్‌లోకి తోయండి, చల్లని నీళ్లు వదలండి, సింక్‌లోని డిస్పోజల్ ఆన్ చేసి వ్యర్థాలను పిండి చేయండి.',
      instructions: ['సింక్ వైపు కిందికి చూడండి.', 'ప్రతి అడుగు మధ్య నెమ్మదిగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'गार्बेज डिस्पोजल वापरणे',
      description:
        'अन्नाचे तुकडे सिंकच्या नाळीत टाका, थंड पाणी सोडा आणि कचरा बारीक करण्यासाठी सिंकमधील डिस्पोजल चालू करा.',
      instructions: ['सिंककडे खाली पाहा.', 'टप्प्यांमध्ये हळूहळू हालचाल करा.'],
      examples: [],
    },
  },
  'Cleaning kitchen counter-top': {
    ...
    'pt-BR': {
      ...
      description:
        'Passe um pano com produto de limpeza na bancada da cozinha para tirar sujeira, restos de comida e manchas.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Pasa un paño con limpiador por la encimera para quitar la suciedad, los restos de comida y las manchas.',
      instructions: ['Mira hacia abajo, a la encimera.', 'Haz giros de cabeza pequeños y suaves.'],
      examples: [],
    },
    'hi-IN': {
      name: 'रसोई का स्लैब साफ़ करना',
      description: 'रसोई के स्लैब को कपड़े और क्लीनर से पोंछें ताकि गंदगी, खाना और दाग हट जाएँ।',
      instructions: ['स्लैब की ओर नीचे देखें।', 'सिर को धीरे-धीरे और हल्के से घुमाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'রান্নাঘরের কাউন্টার পরিষ্কার করা',
      description:
        'কাপড় আর ক্লিনার দিয়ে রান্নাঘরের কাউন্টার মুছে ময়লা, খাবার আর দাগ তুলে ফেলুন।',
      instructions: ['কাউন্টারের দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'சமையலறை கவுண்டரை சுத்தம் செய்வது',
      description:
        'சமையலறை கவுண்டரை துணி மற்றும் கிளீனர் கொண்டு துடைத்து, அழுக்கு, உணவு, கறைகளை நீக்கவும்.',
      instructions: ['கவுண்டரை கீழே பாருங்கள்.', 'தலையை மெதுவாக, சிறிய அசைவுகளில் திருப்புங்கள்.'],
      examples: [],
    },
    'te-IN': {
      name: 'వంటగది అరుగు శుభ్రం చేయడం',
      description: 'మురికి, ఆహారం, మరకలను తీయడానికి గుడ్డ, క్లీనర్‌తో వంటగది అరుగును తుడవండి.',
      instructions: ['అరుగు వైపు కిందికి చూడండి.', 'చిన్నగా, మెల్లగా తల తిప్పండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'स्वयंपाकघराचे ओटा साफ करणे',
      description: 'फडक्याने आणि क्लीनरने ओट्यावरील घाण, अन्न आणि डाग पुसून काढा.',
      instructions: ['ओट्याकडे खाली पाहा.', 'डोके हळूहळू, छोट्या हालचालींनी फिरवा.'],
      examples: [],
    },
  },
  'Cleaning appliances': {
    ...
    'pt-BR': {
      ...
      description:
        'Limpe aparelhos como o micro-ondas, o fogão ou a geladeira por fora e por dentro.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Limpia electrodomésticos como el microondas, la estufa o el refrigerador por fuera y por dentro.',
      instructions: [
    ...
    'bn-IN': {
      ...
      description:
        'মাইক্রোওয়েভ, গ্যাস বা ফ্রিজের মতো যন্ত্র বাইরে আর ভেতর থেকে মুছে পরিষ্কার করুন।',
      instructions: ['যে অংশ পরিষ্কার করছেন সেদিকে তাকান।', 'একেকটা অংশে মসৃণভাবে এগোন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'வீட்டு உபகரணங்களை சுத்தம் செய்வது',
      description:
        'மைக்ரோவேவ், அடுப்பு, ஃபிரிட்ஜ் போன்ற உபகரணங்களை வெளியேயும் உள்ளேயும் துடைத்து சுத்தம் செய்யுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      instructions: ['మీరు శుభ్రం చేస్తున్న భాగం వైపు చూడండి.', 'సెక్షన్ల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
  ...
  Sweeping: {
    ...
    'pt-BR': {
      name: 'Varrer',
      description:
        'Use uma vassoura para juntar a sujeira e a poeira do chão em um canto. Depois recolha com a pá.',
      instructions: [
    ...
    es: {
      name: 'Barrer',
      description:
        'Usa una escoba para juntar la suciedad y el polvo del piso en un solo lugar. Después recógelo con un recogedor.',
      instructions: ['Mira hacia abajo, al piso.', 'Camina despacio con pequeños giros de cabeza.'],
      examples: [],
    },
    'hi-IN': {
      name: 'झाड़ू लगाना',
      description: 'झाड़ू से फ़र्श की धूल और गंदगी एक जगह करें। फिर उसे डस्टपैन में इकट्ठा करें।',
      instructions: ['फ़र्श की ओर नीचे देखें।', 'धीरे-धीरे चलें और हल्के से सिर घुमाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'ঝাঁট দেওয়া',
      description: 'ঝাঁটা দিয়ে মেঝের ময়লা আর ধুলো এক জায়গায় ঠেলে আনুন। তারপর ঝুড়িতে তুলে নিন।',
      instructions: ['মেঝের দিকে তাকান।', 'ছোট ছোট মাথা ঘুরিয়ে আস্তে হাঁটুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'துடைப்பம் போடுவது',
      description:
        'துடைப்பம் கொண்டு தரையில் உள்ள அழுக்கு, தூசுகளை ஒரே இடத்தில் சேர்க்கவும். பின்னர் டஸ்ட்பேனில் எடுக்கவும்.',
      instructions: [
    ...
    'te-IN': {
      name: 'ఊడ్చడం',
      description:
        'నేల మీద ఉన్న మురికి, దుమ్మును చీపురుతో ఒక చోటికి తోయండి. తర్వాత దాన్ని డస్ట్‌ప్యాన్‌లో ఎత్తండి.',
      instructions: ['నేల వైపు కిందికి చూడండి.', 'చిన్నగా తల తిప్పుతూ నెమ్మదిగా నడవండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'झाडू मारणे',
      description: 'झाडूने फरशीवरील धूळ आणि घाण एका जागी जमा करा. नंतर ती सूपात गोळा करा.',
      instructions: ['फरशीकडे खाली पाहा.', 'डोके छोट्या हालचालींनी फिरवत हळूहळू चाला.'],
      examples: [],
    },
  },
  Mopping: {
    ...
    'pt-BR': {
      ...
      description:
        'Use um esfregão molhado para limpar o chão. Molhe o esfregão na água com sabão, torça e passe pelo chão em partes até ficar limpo.',
      instructions: [
        'Olhe para baixo, para o chão.',
        'Ande devagar com pequenos movimentos de cabeça.',
      ],
    ...
    es: {
      name: 'Trapear',
      description:
        'Usa un trapeador mojado para limpiar el piso. Moja el trapeador en agua con jabón, escúrrelo y pasa por el piso por partes hasta que esté limpio.',
      instructions: ['Mira hacia abajo, al piso.', 'Camina despacio con pequeños giros de cabeza.'],
      examples: [],
    },
    'hi-IN': {
      name: 'पोछा लगाना',
      description:
        'गीले पोछे से फ़र्श साफ़ करें। पोछे को साबुन वाले पानी में डुबोएँ, निचोड़ें, और हिस्सों में फ़र्श पोंछें जब तक वह साफ़ न हो जाए।',
      instructions: ['फ़र्श की ओर नीचे देखें।', 'धीरे-धीरे चलें और हल्के से सिर घुमाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'মেঝে মোছা',
      description:
        'ভেজা ন্যাতা দিয়ে মেঝে মুছুন। সাবান-জলে ন্যাতা ডুবিয়ে নিংড়ে অংশে অংশে মুছুন যতক্ষণ না পরিষ্কার হয়।',
      instructions: ['মেঝের দিকে তাকান।', 'ছোট ছোট মাথা ঘুরিয়ে আস্তে হাঁটুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'தரை துடைப்பது',
      description:
        'ஈரமான மொப்பால் தரையை சுத்தம் செய்யுங்கள். மொப்பை சோப்பு தண்ணீரில் தோய்த்து, பிழிந்து, தரையை பகுதி பகுதியாக சுத்தமாகும் வரை துடையுங்கள்.',
      instructions: [
        'தரையை கீழே பாருங்கள்.',
        'மெதுவாக நடந்து, தலையை சிறிது சிறிதாக திருப்புங்கள்.',
      ],
    ...
    'te-IN': {
      ...
      description:
        'తడి మాప్‌తో నేలను శుభ్రం చేయండి. మాప్‌ను సబ్బు నీటిలో ముంచి, పిండి, నేలను భాగాలవారీగా శుభ్రం అయ్యేవరకు తుడవండి.',
      instructions: ['నేల వైపు కిందికి చూడండి.', 'చిన్నగా తల తిప్పుతూ నెమ్మదిగా నడవండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'फरशी पुसणे',
      description:
        'ओल्या पोछ्याने फरशी पुसा. पोछा साबणाच्या पाण्यात बुडवा, पिळून घ्या आणि भाग-भाग करत फरशी स्वच्छ होईपर्यंत पुसा.',
      instructions: ['फरशीकडे खाली पाहा.', 'डोके छोट्या हालचालींनी फिरवत हळूहळू चाला.'],
      examples: [],
    },
  },
  Vacuuming: {
    ...
    'pt-BR': {
      name: 'Aspirar',
      description:
        'Use um aspirador de pó para tirar a poeira e a sujeira do chão, do tapete ou dos móveis.',
      instructions: [
    ...
    es: {
      name: 'Aspirar',
      description:
        'Usa una aspiradora para juntar el polvo y la suciedad del piso, la alfombra o los muebles.',
      instructions: [
    ...
    'ta-IN': {
      ...
      description:
        'வாக்யூம் கிளீனரை பயன்படுத்தி தரை, கம்பளம் அல்லது மரச்சாமான்களில் உள்ள தூசு, அழுக்கை உறிஞ்சவும்.',
      instructions: [
    ...
    'te-IN': {
      name: 'వాక్యూమ్ చేయడం',
      description:
        'నేల, కార్పెట్ లేదా ఫర్నిచర్ నుండి దుమ్ము, మురికిని పీల్చడానికి వాక్యూమ్ క్లీనర్ ఉపయోగించండి.',
      instructions: [
  ...
  Dusting: {
    ...
    'pt-BR': {
      name: 'Tirar o pó',
      description:
        'Use um pano ou espanador para tirar a poeira das prateleiras, mesas e outras superfícies.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Usa un paño o plumero para quitar el polvo de las repisas, mesas y otras superficies.',
      instructions: [
    ...
    'hi-IN': {
      ...
      instructions: ['पोंछते समय सतह की ओर देखें।', 'एक सतह से दूसरी सतह तक आराम से जाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'ঝাড়পোছ করা',
      description: 'কাপড় বা ডাস্টার দিয়ে তাক, টেবিল আর অন্যান্য জায়গা থেকে ধুলো মুছুন।',
      instructions: ['মোছার সময় ওই জায়গার দিকে তাকান।', 'একটার পর একটা জায়গায় মসৃণভাবে যান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'தூசு துடைப்பது',
      description:
        'துணி அல்லது டஸ்டர் கொண்டு அலமாரி, மேசை மற்றும் மற்ற இடங்களில் உள்ள தூசுகளை துடைத்து விடுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      name: 'దుమ్ము తుడవడం',
      description:
        'షెల్ఫ్‌లు, టేబుల్స్, ఇతర ఉపరితలాల మీద దుమ్మును తీయడానికి గుడ్డ లేదా డస్టర్ వాడండి.',
      instructions: ['తుడుస్తున్నప్పుడు ఉపరితలం వైపు చూడండి.', 'ఉపరితలాల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'धूळ झटकणे',
      description: 'फडकं किंवा डस्टरने फळ्या, टेबल आणि इतर पृष्ठभागावरील धूळ पुसा.',
      instructions: ['पुसताना पृष्ठभागाकडे पाहा.', 'एका पृष्ठभागावरून दुसऱ्यावर सहज हालचाल करा.'],
      examples: [],
    },
  },
  'Spraying and wiping surfaces': {
    ...
    'hi-IN': {
      ...
      instructions: ['पोंछते समय सतह की ओर देखें।', 'एक हिस्से से दूसरे हिस्से तक आराम से जाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'স্প্রে করে জায়গা মোছা',
      description: 'কোনো জায়গায় ক্লিনার স্প্রে করে কাপড় দিয়ে মুছে পরিষ্কার করুন।',
      instructions: ['মোছার সময় ওই জায়গার দিকে তাকান।', 'একেকটা অংশে মসৃণভাবে এগোন।'],
      examples: [],
    },
    'ta-IN': {
    ...
    'te-IN': {
      ...
      instructions: ['తుడుస్తున్నప్పుడు ఉపరితలం వైపు చూడండి.', 'సెక్షన్ల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'पृष्ठभाग फवारणे आणि पुसणे',
      description: 'पृष्ठभागावर क्लीनर फवारा आणि फडक्याने पुसून स्वच्छ करा.',
      instructions: ['पुसताना पृष्ठभागाकडे पाहा.', 'एका भागातून दुसऱ्या भागात सहज हालचाल करा.'],
      examples: [],
    },
  },
  'Bathroom cleaning': {
    ...
    'pt-BR': {
      ...
      description:
        'Limpe o vaso sanitário, a pia, o box e os azulejos usando produto, escova e pano.',
      instructions: [
        'Olhe para a parte que você está limpando.',
        'Mova-se com calma entre as áreas.',
      ],
    ...
    es: {
      ...
      description:
        'Limpia el inodoro, el lavabo, la ducha y los azulejos con limpiador, cepillo y paño.',
      instructions: [
        'Mira la parte que estás limpiando.',
        'Muévete con suavidad entre las secciones.',
      ],
    ...
    'ta-IN': {
      ...
      description:
        'கழிப்பறை, சிங்க், ஷவர், டைல்களை கிளீனர், பிரஷ் மற்றும் துணியால் சுத்தம் செய்யவும்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'క్లీనర్, బ్రష్, గుడ్డ ఉపయోగించి టాయిలెట్, సింక్, షవర్, టైల్స్‌ను శుభ్రం చేయండి.',
      instructions: ['మీరు శుభ్రం చేస్తున్న భాగం వైపు చూడండి.', 'సెక్షన్ల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
  ...
  'Cleaning windows and mirrors': {
    ...
    es: {
      ...
      description:
        'Rocía limpiador en el vidrio y pásale un paño o papel hasta que quede transparente.',
      instructions: [
    ...
    'hi-IN': {
      ...
      instructions: ['पोंछते समय काँच की ओर देखें।', 'एक हिस्से से दूसरे हिस्से तक आराम से जाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'জানলা আর আয়না পরিষ্কার করা',
      description: 'কাচে ক্লিনার স্প্রে করে কাপড় বা কাগজ দিয়ে মুছুন যতক্ষণ না ঝকঝকে হয়।',
      instructions: ['মোছার সময় কাচের দিকে তাকান।', 'একেকটা অংশে মসৃণভাবে এগোন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'ஜன்னல்கள் மற்றும் கண்ணாடிகளை சுத்தம் செய்வது',
      description:
        'கண்ணாடியில் கிளீனரை தெளித்து, துணி அல்லது காகிதத்தால் தெளிவாகும் வரை துடையுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      instructions: ['తుడుస్తున్నప్పుడు గాజు వైపు చూడండి.', 'సెక్షన్ల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'खिडक्या आणि आरसे साफ करणे',
      description: 'काचेवर क्लीनर फवारा आणि कापडाने किंवा कागदाने स्वच्छ होईपर्यंत पुसा.',
      instructions: ['पुसताना काचेकडे पाहा.', 'एका भागातून दुसऱ्या भागात सहज हालचाल करा.'],
      examples: [],
    },
  },
  'Emptying or replacing trash bag': {
    ...
    'pt-BR': {
      ...
      description:
        'Tire o saco de lixo cheio da lixeira, amarre e coloque um saco novo dentro da lixeira.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Saca la bolsa de basura llena del bote, átala y coloca una bolsa nueva dentro del bote.',
      instructions: [
    ...
    'bn-IN': {
      ...
      instructions: ['কাজের সময় বিনের দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'குப்பை பையை காலி செய்வது அல்லது மாற்றுவது',
      description:
        'நிறைந்த குப்பை பையை தொட்டியில் இருந்து எடுத்து, கட்டி, ஒரு புதிய பையை தொட்டியில் வையுங்கள்.',
      instructions: [
    ...
    'mr-IN': {
      ...
      instructions: ['काम करताना डब्याकडे खाली पाहा.', 'डोके हळूहळू, छोट्या हालचालींनी फिरवा.'],
      examples: [],
    },
  },
  'Taking out trash': {
    ...
    'pt-BR': {
      ...
      description:
        'Leve o saco de lixo amarrado para fora de casa e coloque na lixeira externa ou no ponto de coleta.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Lleva la bolsa de basura atada desde la casa y déjala en el bote de afuera o en el lugar de recolección.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'बँधी हुई कचरे की थैली घर से बाहर ले जाएँ और बाहर के डिब्बे या कचरा उठाने की जगह पर रखें।',
      instructions: ['थैली रखते समय आगे और डिब्बे की ओर देखें।', 'धीरे और सँभलकर चलें।'],
      examples: [],
    },
    'bn-IN': {
      name: 'আবর্জনা ফেলে আসা',
      description: 'বাঁধা ব্যাগ বাড়ি থেকে নিয়ে গিয়ে বাইরের বিনে বা তোলার জায়গায় রাখুন।',
      instructions: ['ব্যাগ রাখার সময় সামনে আর বিনের দিকে তাকান।', 'আস্তে আর স্থিরভাবে হাঁটুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'குப்பையை வெளியே கொண்டு போவது',
      description:
        'கட்டிய குப்பை பையை வீட்டிலிருந்து எடுத்து, வெளியே உள்ள தொட்டியில் அல்லது சேகரிக்கும் இடத்தில் வையுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'ముడివేసిన చెత్త బ్యాగ్‌ను ఇంటి నుండి తీసుకెళ్లి బయట డబ్బాలో లేదా పికప్ చోట పెట్టండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'बांधलेली कचऱ्याची पिशवी घरातून बाहेर नेऊन बाहेरील डब्यात किंवा पिकअप जागी ठेवा.',
      instructions: ['समोर आणि पिशवी ठेवताना डब्याकडे पाहा.', 'हळूहळू आणि स्थिरपणे चाला.'],
      examples: [],
    },
  },
  'Sweeping outdoor area': {
    ...
    'pt-BR': {
      ...
      description:
        'Use uma vassoura para tirar folhas, poeira e sujeira de áreas externas como varanda ou garagem.',
      instructions: [
        'Olhe para baixo, para o chão.',
        'Ande devagar com pequenos movimentos de cabeça.',
      ],
    ...
    es: {
      ...
      description:
        'Usa una escoba para quitar hojas, polvo y suciedad de pisos exteriores como un porche o una entrada de auto.',
      instructions: ['Mira hacia abajo, al piso.', 'Camina despacio con pequeños giros de cabeza.'],
      examples: [],
    },
    'hi-IN': {
      ...
      description:
        'झाड़ू से बाहर के फ़र्श जैसे बरामदे या ड्राइववे से पत्ते, धूल और गंदगी साफ़ करें।',
      instructions: ['फ़र्श की ओर नीचे देखें।', 'धीरे-धीरे चलें और हल्के से सिर घुमाएँ।'],
      examples: [],
    },
    'bn-IN': {
    ...
    'ta-IN': {
      ...
      description:
        'வராண்டா அல்லது வீட்டின் முற்றம் போன்ற வெளி இடங்களில் உள்ள இலைகள், தூசு, அழுக்கை துடைப்பத்தால் சுத்தம் செய்யவும்.',
      instructions: [
        'தரையை கீழே பாருங்கள்.',
        'மெதுவாக நடந்து, தலையை சிறிது சிறிதாக திருப்புங்கள்.',
      ],
    ...
    'te-IN': {
      ...
      description:
        'వరండా లేదా డ్రైవ్‌వే లాంటి బయటి నేలల నుండి ఆకులు, దుమ్ము, మురికిని తీయడానికి చీపురు ఉపయోగించండి.',
      instructions: ['నేల వైపు కిందికి చూడండి.', 'చిన్నగా తల తిప్పుతూ నెమ్మదిగా నడవండి.'],
      examples: [],
    },
    'mr-IN': {
      ...
      description:
        'व्हरांडा किंवा गाडी ठेवायच्या जागेसारख्या बाहेरील फरशींवरून पानं, धूळ आणि घाण झाडूने काढा.',
      instructions: ['फरशीकडे खाली पाहा.', 'डोके छोट्या हालचालींनी फिरवत हळूहळू चाला.'],
      examples: [],
    },
  },
  'Sorting recyclables': {
    ...
    'pt-BR': {
      ...
      description:
        'Separe latas, garrafas, papel e papelão do lixo comum, colocando cada um na lixeira de reciclagem certa.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Separa latas, botellas, papel y cartón de la basura común y ponlos en los botes de reciclaje correctos.',
      instructions: ['Mira cada cosa antes de separarla.', 'Muévete con suavidad entre los botes.'],
      examples: [],
    },
    'hi-IN': {
      name: 'रीसाइकल वाला सामान छाँटना',
      description:
        'डिब्बे, बोतलें, काग़ज़ और गत्ते को आम कचरे से अलग करके सही रीसाइक्लिंग डिब्बों में डालें।',
      instructions: [
    ...
    'bn-IN': {
      ...
      instructions: ['বাছাইয়ের আগে প্রত্যেকটা জিনিস দেখুন।', 'একেকটা বিনে মসৃণভাবে যান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'மறுசுழற்சி பொருட்களை பிரிப்பது',
      description:
        'டப்பாக்கள், பாட்டில்கள், காகிதம், அட்டைப்பெட்டிகளை சாதாரண குப்பையிலிருந்து பிரித்து, சரியான மறுசுழற்சி தொட்டிகளில் போடுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'డబ్బాలు, బాటిళ్లు, కాగితం, కార్డ్‌బోర్డ్‌ను సాధారణ చెత్త నుండి వేరు చేసి, సరైన రీసైక్లింగ్ డబ్బాలలో పెట్టండి.',
      instructions: ['వర్గీకరించే ముందు ప్రతి వస్తువు వైపు చూడండి.', 'డబ్బాల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'रिसायकल वस्तू वेगळ्या करणे',
      description:
        'डबे, बाटल्या, कागद आणि पुठ्ठा सामान्य कचऱ्यापासून वेगळे करून योग्य रिसायकलिंग डब्यांत टाका.',
      instructions: [
  ...
  'Shoveling snow': {
    ...
    'pt-BR': {
      ...
      description:
        'Use uma pá de neve para tirar a neve da garagem, calçada ou varanda e juntar em uma pilha do lado.',
      instructions: [
        'Olhe para baixo, para a área que está limpando.',
        'Ande devagar com pequenos movimentos de cabeça.',
      ],
    ...
    es: {
      name: 'Palear nieve',
      description:
        'Usa una pala para nieve para levantar y mover la nieve de una entrada, vereda o porche, y amontónala a un lado.',
      instructions: [
        'Mira hacia abajo, al área que estás limpiando.',
        'Camina despacio con pequeños giros de cabeza.',
      ],
    ...
    'hi-IN': {
      name: 'बर्फ़ हटाना',
      description:
        'बर्फ़ के फावड़े से ड्राइववे, रास्ते या बरामदे से बर्फ़ उठाकर एक तरफ़ ढेर बनाएँ।',
      instructions: [
        'जिस जगह को साफ़ कर रहे हैं, उसकी ओर नीचे देखें।',
        'धीरे-धीरे चलें और हल्के से सिर घुमाएँ।',
      ],
    ...
    'bn-IN': {
      name: 'বরফ সরানো',
      description:
        'বরফের কোদাল দিয়ে গাড়ির জায়গা, রাস্তা বা বারান্দা থেকে বরফ তুলে পাশে গাদা করুন।',
      instructions: [
        'যে জায়গা পরিষ্কার করছেন সেদিকে তাকান।',
        'ছোট ছোট মাথা ঘুরিয়ে আস্তে হাঁটুন।',
      ],
    ...
    'ta-IN': {
      name: 'பனியை அள்ளுவது',
      description:
        'ஸ்னோ ஷாவலை பயன்படுத்தி, வீட்டு முற்றம், நடைபாதை அல்லது வராண்டாவில் இருந்து பனியை எடுத்து, ஒரு பக்கம் குவித்து வையுங்கள்.',
      instructions: [
        'சுத்தம் செய்யும் இடத்தை கீழே பாருங்கள்.',
        'மெதுவாக நடந்து, தலையை சிறிது சிறிதாக திருப்புங்கள்.',
      ],
    ...
    'mr-IN': {
      name: 'बर्फ काढणे',
      description:
        'बर्फाच्या फावड्याने गाडीच्या जागेवरून, वाटेवरून किंवा व्हरांड्यावरून बर्फ उचलून बाजूला ढिगाऱ्यात टाका.',
      instructions: [
        'तुम्ही जो भाग साफ करत आहात त्याकडे खाली पाहा.',
        'डोके छोट्या हालचालींनी फिरवत हळूहळू चाला.',
      ],
  ...
  'Organizing a desk': {
    ...
    'pt-BR': {
      ...
      description:
        'Arrume papéis, livros, canetas e outros itens na escrivaninha de forma organizada.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Acomoda los papeles, libros, bolígrafos y otras cosas del escritorio de forma ordenada.',
      instructions: [
    ...
    'hi-IN': {
      ...
      instructions: ['मेज़ की ओर नीचे देखें।', 'चीज़ें हटाते-रखते रहें — खाली खड़े न रहें।'],
      examples: [],
    },
    'bn-IN': {
      name: 'ডেস্ক গোছানো',
    ...
    'ta-IN': {
      ...
      description:
        'மேசையில் உள்ள காகிதங்கள், புத்தகங்கள், பேனாக்கள் மற்றும் பிற பொருட்களை ஒழுங்காக அடுக்கி வையுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      instructions: ['డెస్క్ వైపు కిందికి చూడండి.', 'వస్తువులు కదుపుతూ ఉండండి — ఖాళీగా నిలబడకండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'टेबल लावणे',
      description: 'टेबलवरील कागद, पुस्तकं, पेन आणि इतर वस्तू नीट लावा.',
      instructions: ['टेबलकडे खाली पाहा.', 'वस्तू हलवत राहा — नुसते उभे राहू नका.'],
      examples: [],
    },
  },
  'Organizing a closet or drawer': {
    ...
    'pt-BR': {
      ...
      description:
        'Tire as roupas ou itens do armário ou gaveta, separe e coloque de volta de forma organizada.',
      instructions: [
        'Olhe para o armário ou a gaveta.',
        'Continue mexendo nos itens — não fique parado.',
      ],
    ...
    es: {
      ...
      description:
        'Saca la ropa o las cosas del armario o cajón, ordénalas y vuelve a guardarlas de forma prolija.',
      instructions: ['Mira el armario o el cajón.', 'Sigue moviendo cosas, no te quedes quieto.'],
      examples: [],
    },
    'hi-IN': {
    ...
    'ta-IN': {
      ...
      description:
        'அலமாரி அல்லது இழுப்பறையில் இருந்து துணிகள் அல்லது பொருட்களை எடுத்து, வரிசைப்படுத்தி, ஒழுங்காக மீண்டும் வையுங்கள்.',
      instructions: [
        'அலமாரி அல்லது இழுப்பறையை பாருங்கள்.',
        'பொருட்களை அசைத்துக்கொண்டே இருங்கள் — சும்மா நிற்க வேண்டாம்.',
      ],
    ...
    'te-IN': {
      ...
      description:
        'బీరువా లేదా అర నుండి బట్టలు లేదా వస్తువులు తీసి, వర్గీకరించి, తిరిగి నీట్‌గా పెట్టండి.',
      instructions: ['బీరువా లేదా అర వైపు చూడండి.', 'వస్తువులు కదుపుతూ ఉండండి — ఖాళీగా నిలబడకండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'कपाट किंवा ड्रॉवर लावणे',
      description:
        'कपाट किंवा ड्रॉवरमधून कपडे किंवा वस्तू बाहेर काढा, वेगवेगळ्या करा आणि नीट लावून परत ठेवा.',
      instructions: ['कपाट किंवा ड्रॉवरकडे पाहा.', 'वस्तू हलवत राहा — नुसते उभे राहू नका.'],
      examples: [],
    },
  },
  'Organizing a room': {
    ...
    'pt-BR': {
      ...
      description:
        'Pegue as coisas que estão pelo cômodo, coloque cada uma no lugar certo e deixe o ambiente arrumado.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Recoge las cosas de una habitación, ponlas en su lugar y deja la habitación ordenada.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'कमरे में बिखरी चीज़ें उठाएँ, उनकी सही जगह पर रखें, और कमरे को साफ़-सुथरा बनाएँ।',
      instructions: [
    ...
    'ta-IN': {
      ...
      description:
        'அறையில் உள்ள பொருட்களை எடுத்து, அவற்றை சரியான இடத்தில் வைத்து, அறையை ஒழுங்காக்குங்கள்.',
      instructions: [
  ...
  'Changing sheets or covers': {
    ...
    es: {
      ...
      description:
        'Quita las sábanas, fundas de almohada o cobijas viejas de la cama y pon unas limpias.',
      instructions: [
    ...
    'bn-IN': {
      ...
      instructions: ['কাজের সময় বিছানার দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'படுக்கை விரிப்பு அல்லது உறைகளை மாற்றுவது',
      description:
        'படுக்கையில் இருந்து பழைய விரிப்பு, தலையணை உறை, அல்லது போர்வைகளை எடுத்துவிட்டு, புதியதை போடவும்.',
      instructions: [
    ...
    'mr-IN': {
      ...
      instructions: ['काम करताना पलंगाकडे खाली पाहा.', 'डोके हळूहळू, छोट्या हालचालींनी फिरवा.'],
      examples: [],
    },
  },
  'Making a bed': {
    ...
    'pt-BR': {
      name: 'Arrumar a cama',
      description:
        'Estique o lençol de baixo, espalhe o lençol de cima e o edredom ou cobertor por igual e arrume os travesseiros na cabeceira.',
      instructions: [
        'Olhe para baixo, para a cama, enquanto trabalha.',
        'Faça movimentos suaves e pequenos com a cabeça.',
      ],
    ...
    es: {
      name: 'Tender la cama',
      description:
        'Alisa la sábana ajustable, extiende la sábana de arriba y el edredón o cobija de forma pareja, y acomoda las almohadas en la cabecera.',
      instructions: [
        'Mira hacia abajo, a la cama, mientras trabajas.',
        'Haz giros de cabeza pequeños y suaves.',
      ],
    ...
    'hi-IN': {
      name: 'बिस्तर लगाना',
      description:
        'नीचे की चादर सीधी करें, ऊपर की चादर और रज़ाई या कंबल बराबर बिछाएँ, और तकियों को सिरहाने पर सजाएँ।',
      instructions: [
        'काम करते समय बिस्तर की ओर नीचे देखें।',
        'सिर को धीरे-धीरे और हल्के से घुमाएँ।',
      ],
    ...
    'bn-IN': {
      name: 'বিছানা পাতা',
      description:
        'ফিটেড চাদরটা মসৃণ করে পাতুন, ওপরের চাদর আর কম্বল সমানভাবে বিছান, আর বিছানার মাথার দিকে বালিশ সাজান।',
      instructions: ['কাজের সময় বিছানার দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
      ...
      description:
        'ஃபிட்டெட் ஷீட்டை சரிசெய்து, மேல் விரிப்பு மற்றும் போர்வையை சமமாக விரித்து, தலையணைகளை படுக்கையின் தலைப்பகுதியில் வையுங்கள்.',
      instructions: [
        'வேலை செய்யும்போது படுக்கையை கீழே பாருங்கள்.',
        'தலையை மெதுவாக, சிறிய அசைவுகளில் திருப்புங்கள்.',
      ],
    ...
    'te-IN': {
      name: 'మంచం సర్దడం',
      description:
        'ఫిట్టెడ్ షీట్‌ను సర్దుబాటు చేయండి, టాప్ షీట్, రగ్గు లేదా దుప్పటిని సమంగా పరిచండి, మంచం తలవైపు దిండ్లు అమర్చండి.',
      instructions: [
        'పని చేస్తున్నప్పుడు మంచం వైపు కిందికి చూడండి.',
        'చిన్నగా, మెల్లగా తల తిప్పండి.',
      ],
    ...
    'mr-IN': {
      name: 'पलंग आवरणे',
      description:
        'खालची चादर सपाट करा, वरची चादर आणि पांघरूण किंवा रजई सारखी पसरवा आणि उशा पलंगाच्या डोक्याच्या बाजूला नीट लावा.',
      instructions: ['काम करताना पलंगाकडे खाली पाहा.', 'डोके हळूहळू, छोट्या हालचालींनी फिरवा.'],
      examples: [],
    },
  },
  'Loading or unloading washing machine': {
    ...
    'pt-BR': {
      ...
      description:
        'Coloque roupas sujas na máquina de lavar, ou tire as roupas limpas depois de lavar.',
      instructions: [
        'Olhe para a máquina enquanto trabalha.',
    ...
    'hi-IN': {
      ...
      instructions: ['काम करते समय मशीन की ओर देखें।', 'एक कपड़े से दूसरे कपड़े तक आराम से जाएँ।'],
      examples: [],
    },
    'bn-IN': {
      ...
      instructions: ['কাজের সময় মেশিনের দিকে তাকান।', 'একটার পর একটা কাপড় মসৃণভাবে নিন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'சலவை இயந்திரத்தில் துணிகள் போடுவது அல்லது எடுப்பது',
      description:
        'அழுக்கான துணிகளை சலவை இயந்திரத்தில் போடுங்கள், அல்லது சலவைக்குப் பிறகு சுத்தமான துணிகளை எடுக்கவும்.',
      instructions: [
    ...
    'te-IN': {
      ...
      instructions: ['పని చేస్తున్నప్పుడు మెషీన్ వైపు చూడండి.', 'బట్టల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
  ...
  'Hanging clothes to dry': {
    ...
    es: {
      ...
      description:
        'Cuelga la ropa mojada en un tendedero, una rejilla o una barra para que se seque al aire.',
      instructions: [
    ...
    'bn-IN': {
      ...
      instructions: ['মেলার সময় তার বা র‍্যাকের দিকে তাকান।', 'একটার পর একটা কাপড় মসৃণভাবে নিন।'],
      examples: [],
    },
    'ta-IN': {
    ...
    'te-IN': {
      ...
      instructions: ['ఆరేస్తున్నప్పుడు తీగ లేదా ర్యాక్ వైపు చూడండి.', 'బట్టల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
  ...
  'Removing clothes from drying line': {
    ...
    'hi-IN': {
      ...
      instructions: ['उतारते समय तार की ओर देखें।', 'एक कपड़े से दूसरे कपड़े तक आराम से जाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'শুকোতে দেওয়া কাপড় তুলে নেওয়া',
      description: 'তার বা র‍্যাক থেকে শুকনো কাপড় তুলে ঝুড়িতে রাখুন।',
      instructions: ['কাপড় তোলার সময় তারের দিকে তাকান।', 'একটার পর একটা কাপড় মসৃণভাবে নিন।'],
      examples: [],
    },
    'ta-IN': {
    ...
    'te-IN': {
      ...
      instructions: ['బట్టలు తీస్తున్నప్పుడు తీగ వైపు చూడండి.', 'బట్టల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
  ...
  'Sorting clothes or fabrics': {
    ...
    es: {
      ...
      description:
        'Separa la ropa y las telas en grupos, por ejemplo por color, tipo o a quién pertenecen.',
      instructions: [
    ...
    'hi-IN': {
      ...
      instructions: ['छाँटते समय कपड़ों की ओर नीचे देखें।', 'छाँटते रहें — रुकें नहीं।'],
      examples: [],
    },
    'bn-IN': {
      name: 'কাপড় বাছাই করা',
      description: 'রঙ, ধরন, বা কার সেটা — এমনভাবে কাপড়গুলোকে আলাদা আলাদা ভাগে রাখুন।',
      instructions: ['বাছাইয়ের সময় কাপড়ের দিকে তাকান।', 'বাছাই চালিয়ে যান — থামবেন না।'],
      examples: [],
    },
    'ta-IN': {
    ...
    'te-IN': {
      ...
      description:
        'రంగు, రకం, లేదా ఎవరివి అన్న దాన్ని బట్టి బట్టలను, వస్త్రాలను గ్రూపులుగా వేరు చేయండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      instructions: ['वेगळे करताना कपड्यांकडे खाली पाहा.', 'वेगळे करणे चालू ठेवा — थांबू नका.'],
      examples: [],
    },
  },
  'Folding clothes': {
    ...
    'pt-BR': {
      name: 'Dobrar roupas',
      description:
        'Pegue as roupas limpas e secas e dobre cada uma com capricho. Faça dobras pequenas e iguais para ficar fácil de empilhar ou guardar.',
      instructions: [
    ...
    es: {
      name: 'Doblar ropa',
      description:
        'Toma la ropa limpia y seca y dobla cada prenda con cuidado. Haz dobleces pequeños y parejos para que sea fácil apilar o guardar.',
      instructions: [
    ...
    'hi-IN': {
      name: 'कपड़े तह करना',
      description:
        'साफ़, सूखे कपड़े लें और हर एक को करीने से तह करें। छोटी, बराबर तह करें ताकि कपड़े आसानी से रखे या जमाए जा सकें।',
      instructions: [
    ...
    'bn-IN': {
      name: 'কাপড় ভাঁজ করা',
      description:
        'পরিষ্কার, শুকনো কাপড় নিয়ে একটা একটা করে গুছিয়ে ভাঁজ করুন। ছোট, সমান ভাঁজ দিন যাতে কাপড় সাজিয়ে রাখা যায়।',
      instructions: [
    ...
    'ta-IN': {
      ...
      description:
        'சுத்தமான, காய்ந்த துணிகளை எடுத்து ஒவ்வொன்றையும் ஒழுங்காக மடியுங்கள். சிறிய, சம மடிப்புகளை செய்து, துணிகளை எளிதில் அடுக்கி வைக்கவோ சேமிக்கவோ வசதியாக்குங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'శుభ్రమైన, పొడి బట్టలను తీసి ప్రతిదాన్ని నీట్‌గా మడత పెట్టండి. స్టాక్ చేయడానికి లేదా దాచడానికి సులభంగా ఉండేలా చిన్న, సమానమైన మడతలు పెట్టండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'स्वच्छ, वाळलेले कपडे घेऊन प्रत्येकाची नीट घडी घाला. लहान, सारख्या घड्या घाला म्हणजे कपडे रचून ठेवायला किंवा साठवायला सोपे होतील.',
      instructions: [
  ...
  'Folding towels or bedsheets': {
    ...
    'pt-BR': {
      ...
      description:
        'Dobre tecidos grandes como toalhas e lençóis em quadrados ou retângulos bem arrumados.',
      instructions: [
        'Sente ou fique em pé em um lugar firme.',
        'Olhe para baixo, para as suas mãos.',
        'Faça movimentos suaves e pequenos com a cabeça.',
    ...
    es: {
      ...
      description:
        'Dobla piezas grandes de tela como toallas y sábanas en cuadrados o rectángulos prolijos.',
      instructions: [
        'Siéntate o párate en un lugar estable.',
        'Mira hacia abajo, a tus manos.',
        'Haz giros de cabeza pequeños y suaves.',
    ...
    'ta-IN': {
      ...
      description:
        'டவல், படுக்கை விரிப்பு போன்ற பெரிய துணிகளை ஒழுங்கான சதுர அல்லது நீள்சதுர வடிவில் மடியுங்கள்.',
      instructions: [
        'ஒரு நிலையான இடத்தில் உட்காரவோ நிற்கவோ செய்யுங்கள்.',
        'உங்கள் கைகளை கீழே பாருங்கள்.',
        'தலையை மெதுவாக, சிறிய அசைவுகளில் திருப்புங்கள்.',
    ...
    'te-IN': {
      ...
      description:
        'టవల్‌లు, దుప్పట్లు లాంటి పెద్ద గుడ్డలను నీట్‌గా చతురస్రాలు లేదా దీర్ఘచతురస్రాలుగా మడత పెట్టండి.',
      instructions: [
        'స్థిరమైన చోట కూర్చోండి లేదా నిలబడండి.',
        'మీ చేతుల వైపు కిందికి చూడండి.',
        'చిన్నగా, మెల్లగా తల తిప్పండి.',
  ...
  'Ironing clothes': {
    ...
    'bn-IN': {
      ...
      instructions: ['ইস্ত্রির সময় কাপড়ের দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
  ...
  'Post-washing laundry (sort → fold → store)': {
    ...
    'pt-BR': {
      ...
      description:
        'Pegue as roupas secas, separe, dobre cada uma e guarde no lugar certo, como no armário ou na gaveta.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Toma la ropa seca, sepárala, dobla cada prenda y guárdala donde corresponda, como en el armario o el cajón.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'सूखे कपड़े लें, छाँटें, हर एक को तह करें, और उनकी जगह पर रखें — जैसे अलमारी या दराज़ में।',
      instructions: ['काम करते समय कपड़ों की ओर नीचे देखें।', 'काम करते रहें — रुकें नहीं।'],
      examples: [],
    },
    'bn-IN': {
      name: 'কাপড় কাচার পরের কাজ (বাছাই → ভাঁজ → রাখা)',
      description:
        'শুকনো কাপড় নিয়ে বাছাই করুন, একটা একটা ভাঁজ করুন, আর আলমারি বা ড্রয়ারে নিজ নিজ জায়গায় রাখুন।',
      instructions: ['কাজের সময় কাপড়ের দিকে তাকান।', 'কাজ চালিয়ে যান — থামবেন না।'],
      examples: [],
    },
    'ta-IN': {
      name: 'சலவைக்குப் பிறகான வேலை (பிரித்தல் → மடித்தல் → வைத்தல்)',
      description:
        'காய்ந்த துணிகளை எடுத்து, பிரித்து, ஒவ்வொன்றையும் மடித்து, அவை சேர வேண்டிய இடத்தில் — அலமாரி அல்லது இழுப்பறையில் — வையுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'ఆరిన బట్టలను తీసుకొని, వేరు చేసి, ప్రతిదాన్ని మడత పెట్టి, బీరువా లేదా అరలో దాని చోట పెట్టండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'वाळलेले कपडे घ्या, वेगवेगळे करा, प्रत्येकाची घडी घाला आणि कपाटात किंवा ड्रॉवरमध्ये त्यांच्या जागी ठेवा.',
      instructions: ['काम करताना कपड्यांकडे खाली पाहा.', 'काम चालू ठेवा — थांबू नका.'],
      examples: [],
    },
  },
  'Loading or unloading clothes dryer': {
    ...
    'pt-BR': {
      ...
      description:
        'Passe as roupas molhadas da máquina de lavar para a secadora, ou tire as roupas secas da secadora para um cesto.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Pasa la ropa mojada de la lavadora a la secadora, o saca la ropa seca de la secadora a una canasta.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'गीले कपड़े वॉशर से ड्रायर में डालें, या सूखे कपड़े ड्रायर से निकालकर टोकरी में रखें।',
      instructions: [
    ...
    'bn-IN': {
      ...
      description:
        'ওয়াশার থেকে ভেজা কাপড় ড্রায়ারে নিন, অথবা ড্রায়ার থেকে শুকনো কাপড় ঝুড়িতে বের করুন।',
      instructions: ['কাজের সময় ড্রায়ারের দিকে তাকান।', 'একটার পর একটা কাপড় মসৃণভাবে নিন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'டிரையரில் துணி போடுவது அல்லது எடுப்பது',
      description:
        'ஈரமான துணிகளை வாஷரில் இருந்து டிரையருக்கு மாற்றுங்கள், அல்லது காய்ந்த துணிகளை டிரையரிலிருந்து கூடைக்கு எடுத்துக் கொள்ளுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'తడి బట్టలను వాషర్ నుండి డ్రయర్‌లోకి వేయండి, లేదా ఆరిన బట్టలను డ్రయర్ నుండి బుట్టలోకి తీయండి.',
      instructions: ['పని చేస్తున్నప్పుడు డ్రయర్ వైపు చూడండి.', 'బట్టల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
  ...
  'Cleaning the dryer lint trap': {
    ...
    'pt-BR': {
      ...
      description:
        'Puxe a tela do filtro de fiapos da secadora, tire a camada de fiapos com os dedos e encaixe a tela de volta.',
      instructions: ['Olhe para baixo, para a tela do filtro.', 'Mova-se devagar e com firmeza.'],
      examples: [],
    },
    es: {
      name: 'Limpiar el filtro de pelusa de la secadora',
      description:
        'Saca el filtro de pelusa de la secadora, quita la capa de pelusa con los dedos y vuelve a colocar el filtro.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'ड्रायर से लिंट की जाली निकालें, उंगलियों से जमी रुई की परत हटाएँ, और जाली वापस लगाएँ।',
      instructions: ['लिंट की जाली की ओर नीचे देखें।', 'धीरे और सँभलकर काम करें।'],
      examples: [],
    },
    'bn-IN': {
      name: 'ড্রায়ারের লিন্ট ট্র্যাপ পরিষ্কার করা',
      description:
        'ড্রায়ার থেকে লিন্টের জালিটা বের করুন, আঙুল দিয়ে জমে থাকা লিন্ট তুলে ফেলুন, আর জালি আবার ঢুকিয়ে দিন।',
      instructions: ['লিন্টের জালির দিকে তাকান।', 'আস্তে আর স্থিরভাবে নাড়ুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'டிரையர் லின்ட் டிராப் சுத்தம் செய்வது',
      description:
        'டிரையரில் இருந்து லின்ட் திரையை வெளியே இழுத்து, கைகளால் லின்ட் அடுக்கை எடுத்து, திரையை மீண்டும் உள்ளே நுழைக்கவும்.',
      instructions: ['லின்ட் திரையை கீழே பாருங்கள்.', 'மெதுவாக, நிலையாக நகருங்கள்.'],
      examples: [],
    },
    'te-IN': {
      name: 'డ్రయర్ లింట్ ట్రాప్ శుభ్రం చేయడం',
      description:
        'డ్రయర్ నుండి లింట్ స్క్రీన్ తీయండి, వేళ్లతో పేరుకుపోయిన లింట్ తీసి, స్క్రీన్‌ను తిరిగి లోపలికి జారనివ్వండి.',
      instructions: ['లింట్ స్క్రీన్ వైపు కిందికి చూడండి.', 'నెమ్మదిగా, స్థిరంగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'ड्रायरचा लिंट ट्रॅप साफ करणे',
      description:
        'ड्रायरमधून लिंट स्क्रीन बाहेर काढा, बोटांनी त्यावरचा लिंटचा थर काढा आणि स्क्रीन पुन्हा आत सरकवा.',
      instructions: ['लिंट स्क्रीनकडे खाली पाहा.', 'हळूहळू आणि स्थिरपणे हालचाल करा.'],
      examples: [],
    },
  },
  'Folding a fitted sheet': {
    ...
    'pt-BR': {
      ...
      description:
        'Encaixe os cantos do lençol com elástico um dentro do outro e dobre em um retângulo bem chato.',
      instructions: [
        'Sente ou fique em pé em um lugar firme.',
        'Olhe para baixo, para as suas mãos.',
    ...
    es: {
      ...
      description:
        'Mete las esquinas de la sábana ajustable una dentro de la otra y dóblala en un rectángulo plano.',
      instructions: [
        'Siéntate o párate en un lugar estable.',
        'Mira hacia abajo, a tus manos.',
        'Muévete despacio y con paso firme.',
    ...
    'bn-IN': {
      ...
      description:
        'ফিটেড চাদরের কোণাগুলো একে অন্যের ভেতর গুঁজে দিয়ে চ্যাপ্টা আয়তাকার করে ভাঁজ করুন।',
      instructions: [
        'একটা স্থির জায়গায় বসুন বা দাঁড়ান।',
        'নিজের হাতের দিকে তাকান।',
    ...
    'ta-IN': {
      ...
      description:
        'ஃபிட்டெட் ஷீட்டின் ஓரங்களை ஒன்றில் ஒன்று உள்ளே வைத்து, தட்டையான நீள்சதுரமாக மடியுங்கள்.',
      instructions: [
        'ஒரு நிலையான இடத்தில் உட்காரவோ நிற்கவோ செய்யுங்கள்.',
        'உங்கள் கைகளை கீழே பாருங்கள்.',
  ...
  'Watering plants': {
    ...
    'pt-BR': {
      ...
      description:
        'Coloque água nas plantas usando um regador, mangueira ou garrafa. Dê água suficiente para cada planta para a terra ficar úmida, mas não encharcada.',
      instructions: ['Olhe para cada planta enquanto rega.', 'Ande devagar entre as plantas.'],
      examples: [],
    },
    es: {
      name: 'Regar las plantas',
      description:
        'Echa agua a las plantas con una regadera, manguera o botella. Dale a cada planta suficiente agua para que la tierra quede húmeda pero no inundada.',
      instructions: ['Mira cada planta mientras la riegas.', 'Camina despacio entre las plantas.'],
      examples: [],
    },
    'hi-IN': {
      name: 'पौधों को पानी देना',
      description:
        'कैन, पाइप या बोतल से पौधों पर पानी डालें। हर पौधे को इतना पानी दें कि मिट्टी गीली हो जाए पर भर न जाए।',
      instructions: ['हर पौधे को पानी देते समय उसकी ओर देखें।', 'पौधों के बीच धीरे-धीरे चलें।'],
      examples: [],
    },
    'bn-IN': {
      name: 'গাছে জল দেওয়া',
      description:
        'ঝাঝরি, পাইপ বা বোতল দিয়ে গাছে জল দিন। প্রত্যেকটা গাছে যথেষ্ট জল দিন যাতে মাটি ভেজা থাকে কিন্তু জলে ভেসে না যায়।',
      instructions: [
    ...
    'ta-IN': {
      ...
      description:
        'டப்பா, ஹோஸ் அல்லது பாட்டிலால் செடிகளுக்கு தண்ணீர் ஊற்றுங்கள். ஒவ்வொரு செடிக்கும் மண் ஈரமாக ஆனால் வெள்ளம் போல் இல்லாத அளவுக்கு தண்ணீர் கொடுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'క్యాన్, పైపు లేదా బాటిల్ ఉపయోగించి మొక్కలకు నీళ్లు పోయండి. మట్టి తడిగా అయ్యే వరకు ప్రతి మొక్కకు తగినన్ని నీళ్లు పోయండి, కానీ మరీ ఎక్కువ కాదు.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'झारी, पाइप किंवा बाटलीने झाडांना पाणी घाला. प्रत्येक झाडाला माती ओली होईल पण साचेल नाही इतके पाणी द्या.',
      instructions: ['प्रत्येक झाडाला पाणी घालताना त्याकडे पाहा.', 'झाडांमधून हळूहळू चाला.'],
      examples: [],
    },
  },
  'Planting or repotting': {
    ...
    'pt-BR': {
      ...
      description:
        'Coloque uma muda ou semente na terra de um vaso ou no chão. Aperte a terra em volta com firmeza.',
      instructions: [
        'Olhe para baixo, para as suas mãos.',
        'Faça movimentos suaves e pequenos com a cabeça.',
      ],
    ...
    es: {
      ...
      description:
        'Coloca una planta o semilla en la tierra de una maceta o en el suelo. Aprieta bien la tierra a su alrededor.',
      instructions: ['Mira hacia abajo, a tus manos.', 'Haz giros de cabeza pequeños y suaves.'],
      examples: [],
    },
    'hi-IN': {
    ...
    'ta-IN': {
      ...
      description:
        'ஒரு செடி அல்லது விதையை தொட்டியில் அல்லது தரையில் மண்ணில் வையுங்கள். சுற்றி மண்ணை இறுக்கமாக அழுத்தி நிரப்புங்கள்.',
      instructions: [
        'உங்கள் கைகளை கீழே பாருங்கள்.',
        'தலையை மெதுவாக, சிறிய அசைவுகளில் திருப்புங்கள்.',
      ],
    ...
    'te-IN': {
      ...
      description:
        'మొక్క లేదా విత్తనాన్ని కుండీలో లేదా నేలలో మట్టిలో పెట్టండి. చుట్టూ మట్టిని గట్టిగా నొక్కండి.',
      instructions: ['మీ చేతుల వైపు కిందికి చూడండి.', 'చిన్నగా, మెల్లగా తల తిప్పండి.'],
      examples: [],
    },
    'mr-IN': {
  ...
  'Pruning or trimming': {
    ...
    'pt-BR': {
      ...
      description:
        'Use uma tesoura ou tesourão para cortar folhas, galhos ou hastes a mais das plantas.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Usa tijeras o podadoras para cortar las hojas, tallos o ramas de más de las plantas.',
      instructions: ['Mira la parte que estás cortando.', 'Haz giros de cabeza pequeños y suaves.'],
      examples: [],
    },
    'hi-IN': {
      name: 'पौधों की छँटाई',
    ...
    'bn-IN': {
      ...
      instructions: ['যে অংশ কাটছেন সেদিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'செடி கத்தரித்தல்',
      description:
        'கத்தரிக்கோல் அல்லது பிரூனிங் கருவியை வைத்து செடிகளில் உள்ள அதிகமான இலைகள், தண்டுகள், கிளைகளை வெட்டி எடுக்கவும்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'కత్తెర లేదా శియర్స్‌తో మొక్కల నుండి అదనపు ఆకులు, కాండాలు లేదా కొమ్మలను కత్తిరించండి.',
      instructions: ['మీరు కత్తిరిస్తున్న భాగం వైపు చూడండి.', 'చిన్నగా, మెల్లగా తల తిప్పండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'छाटणी करणे',
  ...
  Hoeing: {
    ...
    'pt-BR': {
      ...
      instructions: ['Olhe para baixo, para a terra.', 'Mova-se com calma e firmeza.'],
      examples: [],
    },
    es: {
      name: 'Cavar con azada',
      description: 'Usa una azada para aflojar la tierra, quitar la maleza o darle forma al suelo.',
      instructions: ['Mira hacia abajo, a la tierra.', 'Muévete con suavidad y paso firme.'],
      examples: [],
    },
    'hi-IN': {
      name: 'कुदाल चलाना',
      description: 'कुदाल से मिट्टी तोड़ें, खरपतवार हटाएँ, या ज़मीन को आकार दें।',
      instructions: ['मिट्टी की ओर नीचे देखें।', 'आराम और एक रफ़्तार से काम करें।'],
      examples: [],
    },
    'bn-IN': {
      name: 'কোদাল দিয়ে কোপানো',
      description: 'কোদাল দিয়ে মাটি ভাঙুন, আগাছা সরান, বা জমি ঠিকঠাক করুন।',
      instructions: ['মাটির দিকে তাকান।', 'মসৃণ আর স্থিরভাবে নাড়ুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'மண் கொத்துவது',
      description:
        'கொத்து மண்வெட்டியை வைத்து மண்ணை உடைக்கவோ, களைகளை நீக்கவோ, தரையை வடிவமைக்கவோ செய்யுங்கள்.',
      instructions: ['மண்ணை கீழே பாருங்கள்.', 'மெதுவாக, நிலையாக நகருங்கள்.'],
      examples: [],
    },
    'te-IN': {
      name: 'గుడ్డలి తోటపని',
      description:
        'గుడ్డలి ఉపయోగించి మట్టిని తెగగొట్టడం, కలుపు మొక్కలు తీయడం లేదా నేలను ఆకారం చేయడం.',
      instructions: ['మట్టి వైపు కిందికి చూడండి.', 'మెల్లగా, స్థిరంగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'कुदळ चालवणे',
      description: 'कुदळीने माती सैल करा, तण काढा किंवा जमीन आकार द्या.',
      instructions: ['मातीकडे खाली पाहा.', 'सहज आणि स्थिरपणे हालचाल करा.'],
      examples: [],
    },
  },
  'Mowing the lawn': {
    ...
    'pt-BR': {
      name: 'Cortar a grama',
      description:
        'Use um cortador de grama para deixar a grama do chão com uma altura curta e parelha.',
      instructions: ['Olhe para baixo, para a grama na sua frente.', 'Ande devagar e com firmeza.'],
      examples: [],
    },
    es: {
      name: 'Cortar el césped',
      description:
        'Usa una cortadora de césped para cortar el pasto del suelo a una altura pareja y corta.',
      instructions: [
    ...
    'hi-IN': {
      ...
      instructions: ['सामने की घास की ओर नीचे देखें।', 'धीरे और एक रफ़्तार से चलें।'],
      examples: [],
    },
    'bn-IN': {
      name: 'লন কাটা',
      description: 'লন মোয়ার দিয়ে মাটির ঘাস সমান আর ছোট করে কাটুন।',
      instructions: ['সামনের ঘাসের দিকে তাকান।', 'আস্তে আর স্থিরভাবে হাঁটুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'புல்வெளியை வெட்டுவது',
      description: 'லான் மோவரை பயன்படுத்தி தரையில் உள்ள புல்லை சம, குறுகிய உயரத்தில் வெட்டவும்.',
      instructions: ['உங்கள் முன் உள்ள புல்லை கீழே பாருங்கள்.', 'மெதுவாக, நிலையாக நடக்கவும்.'],
      examples: [],
    },
    'te-IN': {
      name: 'గడ్డి మొవ్వడం',
      description: 'నేల మీద గడ్డిని సమంగా, పొట్టిగా కత్తిరించడానికి లాన్ మోవర్ ఉపయోగించండి.',
      instructions: ['మీ ముందున్న గడ్డి వైపు కిందికి చూడండి.', 'నెమ్మదిగా, స్థిరంగా నడవండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'लॉन कापणे',
      description: 'लॉन मोवरने जमिनीवरील गवत सारख्या, कमी उंचीवर कापा.',
      instructions: ['समोरील गवताकडे खाली पाहा.', 'हळूहळू आणि स्थिरपणे चाला.'],
      examples: [],
    },
  },
  'Raking leaves': {
    ...
    'hi-IN': {
      ...
      instructions: ['पत्तों और रेक की ओर नीचे देखें।', 'सिर को धीरे-धीरे और हल्के से घुमाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'পাতা ঝাঁট দেওয়া',
      description: 'রেক দিয়ে মাটিতে পড়ে থাকা পাতা একসাথে গাদা করুন।',
      instructions: ['পাতা আর রেকের দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
    ...
    'te-IN': {
      ...
      instructions: ['ఆకులు, రేక్ వైపు కిందికి చూడండి.', 'చిన్నగా, మెల్లగా తల తిప్పండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'पानं गोळा करणे',
      description: 'रेकने जमिनीवरील पडलेली पानं एका ढिगात ओढा.',
      instructions: ['पानं आणि रेककडे खाली पाहा.', 'डोके हळूहळू, छोट्या हालचालींनी फिरवा.'],
      examples: [],
    },
  },
  'Harvesting fruits or vegetables': {
    ...
    'pt-BR': {
      ...
      description:
        'Colha frutas ou legumes das plantas com a mão ou com uma ferramenta e coloque em um cesto ou sacola.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Recoge frutas o verduras de las plantas con la mano o con una herramienta, y ponlas en una canasta o bolsa.',
      instructions: [
    ...
    'hi-IN': {
      ...
      instructions: ['तोड़ते समय फल या सब्ज़ी की ओर देखें।', 'एक से दूसरे तक आराम से जाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'ফল বা সবজি তোলা',
      description: 'হাতে বা যন্ত্র দিয়ে গাছ থেকে ফল বা সবজি তুলুন, আর ঝুড়ি বা ব্যাগে রাখুন।',
      instructions: ['তোলার সময় ফল বা সবজির দিকে তাকান।', 'একটার পর একটা মসৃণভাবে তুলুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'பழங்கள் அல்லது காய்கறிகளை அறுவடை செய்வது',
      description:
        'செடிகளில் இருந்து பழங்கள் அல்லது காய்கறிகளை கையால் அல்லது கருவியால் பறித்து, ஒரு கூடை அல்லது பையில் வையுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'చేతితో లేదా పరికరంతో మొక్కల నుండి పండ్లు లేదా కూరగాయలను కోసి బుట్ట లేదా బ్యాగులో పెట్టండి.',
      instructions: ['కోస్తున్నప్పుడు పండు లేదా కూరగాయ వైపు చూడండి.', 'కోతల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'फळं किंवा भाज्या तोडणे',
      description:
        'झाडांवरून हाताने किंवा हत्याराने फळं किंवा भाज्या तोडा आणि टोपलीत किंवा पिशवीत ठेवा.',
      instructions: ['तोडताना फळ किंवा भाजीकडे पाहा.', 'एका तोडणीतून दुसरीकडे सहज हालचाल करा.'],
      examples: [],
    },
  },
  'Coiling a hose': {
    ...
    'pt-BR': {
      ...
      description:
        'Enrole a mangueira de jardim em círculo de forma organizada para poder guardar.',
      instructions: [
        'Olhe para baixo, para as suas mãos.',
        'Faça movimentos suaves e pequenos com a cabeça.',
      ],
  ...
  'Bagging leaves': {
    ...
    'pt-BR': {
      name: 'Ensacar folhas',
      description:
        'Junte as pilhas de folhas com as mãos ou uma pá e coloque em sacos de lixo de jardim.',
      instructions: [
    ...
    es: {
      name: 'Embolsar hojas',
      description:
        'Junta los montones de hojas rastrilladas con las manos o con un recogedor y mételos en bolsas para residuos de jardín.',
      instructions: ['Mira hacia abajo, a las hojas.', 'Haz giros de cabeza pequeños y suaves.'],
      examples: [],
    },
    'hi-IN': {
      name: 'पत्तों को थैले में भरना',
      description:
        'बटोरे हुए पत्तों के ढेर को हाथों या स्कूप से उठाकर बगीचे के कचरे के थैलों में डालें।',
      instructions: ['पत्तों की ओर नीचे देखें।', 'सिर को धीरे-धीरे और हल्के से घुमाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'পাতা ব্যাগে ভরা',
      description: 'ঝাঁট দেওয়া পাতার গাদা হাত বা ঝুড়ি দিয়ে তুলে বাগানের আবর্জনার ব্যাগে ভরুন।',
      instructions: ['পাতার দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'இலைகளை பையில் போடுவது',
      description:
        'கூட்டிய இலை குவியல்களை கையால் அல்லது அள்ளும் கருவியால் எடுத்து, தோட்டக் கழிவு பைகளில் போடுங்கள்.',
      instructions: ['இலைகளை கீழே பாருங்கள்.', 'தலையை மெதுவாக, சிறிய அசைவுகளில் திருப்புங்கள்.'],
      examples: [],
    },
    'te-IN': {
      name: 'ఆకులను బ్యాగ్‌లో నింపడం',
      description:
        'చిమ్మిన ఆకుల కుప్పలను చేతులతో లేదా స్కూప్‌తో ఎత్తి యార్డ్-వ్యర్థాల బ్యాగుల్లో వేయండి.',
      instructions: ['ఆకుల వైపు కిందికి చూడండి.', 'చిన్నగా, మెల్లగా తల తిప్పండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'पानं पिशवीत भरणे',
      description:
        'गोळा केलेल्या पानांचे ढिगारे हाताने किंवा स्कूपने उचलून यार्ड-वेस्ट पिशव्यांत भरा.',
      instructions: ['पानांकडे खाली पाहा.', 'डोके हळूहळू, छोट्या हालचालींनी फिरवा.'],
      examples: [],
    },
  },
  'Pulling weeds by hand': {
    ...
    'pt-BR': {
      ...
      description:
        'Segure o mato pela base e puxe da terra com raiz e tudo, depois coloque em uma pilha ou saco.',
      instructions: ['Olhe para baixo, para a terra.', 'Mova-se devagar entre as plantas.'],
      examples: [],
    },
    es: {
      name: 'Arrancar maleza a mano',
      description:
        'Agarra la maleza por la base y sácala de la tierra con todo y raíz, luego ponla en un montón o bolsa.',
      instructions: ['Mira hacia abajo, a la tierra.', 'Muévete despacio entre las malezas.'],
      examples: [],
    },
    'hi-IN': {
      name: 'हाथ से खरपतवार उखाड़ना',
      description:
        'खरपतवार को जड़ के पास से पकड़कर मिट्टी से जड़ समेत खींचें, और ढेर या थैले में डालें।',
      instructions: ['मिट्टी की ओर नीचे देखें।', 'एक खरपतवार से दूसरी तक धीरे-धीरे जाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'হাতে আগাছা তোলা',
      description:
        'আগাছার গোড়া ধরে শিকড়সহ মাটি থেকে টেনে তুলুন, আর গাদা করে রাখুন বা ব্যাগে ফেলুন।',
      instructions: ['মাটির দিকে তাকান।', 'এক আগাছা থেকে অন্যটায় আস্তে যান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'களைகளை கையால் பிடுங்குவது',
      description:
        'களைகளின் அடிப்பகுதியை பிடித்து, வேருடன் சேர்த்து மண்ணில் இருந்து இழுத்து எடுங்கள், பின்னர் ஒரு குவியலில் அல்லது பையில் போடுங்கள்.',
      instructions: ['மண்ணை கீழே பாருங்கள்.', 'ஒரு களையிலிருந்து இன்னொன்றுக்கு மெதுவாக நகருங்கள்.'],
      examples: [],
    },
    'te-IN': {
      name: 'చేత్తో కలుపు మొక్కలు పీకడం',
      description:
        'కలుపు మొక్కలను అడుగున పట్టుకొని వేళ్లతో సహా మట్టి నుండి పీకి, కుప్ప లేదా బ్యాగులో వేయండి.',
      instructions: ['మట్టి వైపు కిందికి చూడండి.', 'కలుపు మొక్కల మధ్య నెమ్మదిగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'हाताने तण उपटणे',
      description: 'तणाला खालून पकडा आणि मुळासकट मातीतून बाहेर ओढा, मग ती ढिगात किंवा पिशवीत ठेवा.',
      instructions: ['मातीकडे खाली पाहा.', 'एका तणाकडून दुसऱ्या तणाकडे हळूहळू जा.'],
      examples: [],
    },
  },
  'Filling a feeding bowl': {
    ...
    'hi-IN': {
      ...
      instructions: ['डालते समय कटोरे की ओर नीचे देखें।', 'सिर को धीरे-धीरे और हल्के से घुमाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'খাবারের বাটি ভরা',
      description: 'পোষ্যর বাটিতে খাবার ঢেলে যেখানে সে খায় সেখানে রেখে দিন।',
      instructions: ['ঢালার সময় বাটির দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
    ...
    'mr-IN': {
      ...
      instructions: ['ओतताना वाटीकडे खाली पाहा.', 'डोके हळूहळू, छोट्या हालचालींनी फिरवा.'],
      examples: [],
    },
  },
  'Emptying or cleaning feeding bowl': {
    ...
    'bn-IN': {
      ...
      instructions: ['পরিষ্কার করার সময় বাটির দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
    ...
    'mr-IN': {
      ...
      instructions: ['साफ करताना वाटीकडे खाली पाहा.', 'डोके हळूहळू, छोट्या हालचालींनी फिरवा.'],
      examples: [],
    },
  },
  'Clearing a litter box': {
    ...
    'pt-BR': {
      ...
      description:
        'Tire a areia usada da caixa do gato com a pá e jogue no lixo. Coloque areia nova se precisar.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Saca con una pala la arena usada de la caja y tírala a la basura. Agrega arena nueva si hace falta.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'लिटर बॉक्स से इस्तेमाल हुई लिटर निकालकर कचरे में डालें। ज़रूरत हो तो नई लिटर डालें।',
      instructions: [
    ...
    'bn-IN': {
      ...
      description:
        'লিটার বক্স থেকে ব্যবহার করা লিটার তুলে আবর্জনায় ফেলুন। দরকার হলে নতুন লিটার দিন।',
      instructions: ['তোলার সময় বক্সের দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'லிட்டர் பெட்டியை சுத்தம் செய்வது',
      description:
        'லிட்டர் பெட்டியிலிருந்து உபயோகித்த லிட்டரை எடுத்து குப்பையில் போடுங்கள். தேவைப்பட்டால் புதிய லிட்டரை சேர்க்கவும்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'లిట్టర్ బాక్స్ నుండి వాడిన లిట్టర్‌ను స్కూప్‌తో తీసి చెత్తలో వేయండి. అవసరమైతే తాజా లిట్టర్ వేయండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      instructions: ['काढताना बॉक्सकडे खाली पाहा.', 'डोके हळूहळू, छोट्या हालचालींनी फिरवा.'],
      examples: [],
    },
  },
  'Refilling water bowl': {
    ...
    'ta-IN': {
      ...
      description:
        'வளர்ப்பு பிராணியின் கிண்ணத்தில் உள்ள பழைய தண்ணீரை ஊற்றிவிட்டு, புதிய தண்ணீரை நிரப்புங்கள்.',
      instructions: [
        'ஊற்றும்போது கிண்ணத்தை கீழே பாருங்கள்.',
        'தலையை மெதுவாக, சிறிய அசைவுகளில் திருப்புங்கள்.',
      ],
  ...
  'Brushing or grooming a pet': {
    ...
    'pt-BR': {
      ...
      description:
        'Use uma escova para pentear o pelo do seu bicho. Passe a escova com cuidado, da cabeça até a cauda, para tirar os pelos soltos e os nós.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Usa un cepillo para peinar el pelo de tu mascota. Pasa el cepillo con suavidad de la cabeza a la cola para quitar el pelo suelto y los nudos.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'ब्रश से अपने पालतू जानवर के बालों को सँवारें। ब्रश को सिर से पूँछ तक धीरे-धीरे चलाएँ ताकि झड़े बाल और उलझनें निकल जाएँ।',
      instructions: [
    ...
    'bn-IN': {
      ...
      description:
        'ব্রাশ দিয়ে পোষ্যর লোম আঁচড়ান। মাথা থেকে লেজ পর্যন্ত আস্তে ব্রাশ চালিয়ে আলগা লোম আর জটা ছাড়িয়ে দিন।',
      instructions: ['ব্রাশ করার সময় পোষ্যর দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'வளர்ப்பு பிராணியை சீவுவது',
      description:
        'ஒரு பிரஷ்ஷை வைத்து உங்கள் வளர்ப்பு பிராணியின் ரோமத்தை சீவுங்கள். தலை முதல் வால் வரை மெதுவாக பிரஷ்ஷை அசைத்து, உதிர்ந்த ரோமங்கள் மற்றும் சிக்கல்களை அகற்றுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'మీ పెంపుడు జంతువు బొచ్చును బ్రష్‌తో దువ్వండి. తల నుండి తోక వరకు సున్నితంగా బ్రష్ కదిలించి, ఊడిన వెంట్రుకలు, చిక్కులు తీయండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'तुमच्या पाळीव प्राण्याच्या केसांना ब्रशने विंचरा. डोक्यापासून शेपटीपर्यंत हळुवारपणे ब्रश फिरवा, म्हणजे सुटलेले केस आणि गुंते निघतील.',
      instructions: [
  ...
  'Bathing a pet': {
    ...
    es: {
      ...
      description:
        'Lava a tu mascota con agua y champú para mascotas. Enjuaga bien y seca con una toalla.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'अपने पालतू जानवर को पानी और पेट शैम्पू से नहलाएँ। अच्छे से धोएँ और तौलिये से पोंछें।',
      instructions: ['नहलाते समय पालतू जानवर की ओर देखें।', 'सिर को धीरे-धीरे और हल्के से घुमाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'পোষ্যকে স্নান করানো',
      description:
        'জল আর পোষ্যর শ্যাম্পু দিয়ে পোষ্যকে ধুয়ে দিন। ভালো করে ধুয়ে তোয়ালে দিয়ে মুছে দিন।',
      instructions: ['ধোয়ার সময় পোষ্যর দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'வளர்ப்பு பிராணிக்கு குளியல் கொடுப்பது',
      description:
        'தண்ணீர் மற்றும் பிராணிகளுக்கான ஷாம்பு கொண்டு உங்கள் வளர்ப்பு பிராணியை குளிப்பாட்டுங்கள். நன்றாக அலசி, துண்டில் துடைத்து உலர்த்தவும்.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'पाण्याने आणि पेट शॅम्पूने तुमच्या पाळीव प्राण्याला धुवा. नीट विसळा आणि टॉवेलने वाळवा.',
      instructions: ['धुताना पाळीव प्राण्याकडे पाहा.', 'डोके हळूहळू, छोट्या हालचालींनी फिरवा.'],
      examples: [],
    },
  },
  'Walking a pet': {
    ...
    'hi-IN': {
      ...
      instructions: ['चलते समय आगे और पालतू जानवर की ओर देखें।', 'एक रफ़्तार से चलें।'],
      examples: [],
    },
    'bn-IN': {
      name: 'পোষ্যকে বেড়াতে নিয়ে যাওয়া',
      description: 'পোষ্যকে দড়ি লাগিয়ে বাইরে বেড়াতে নিয়ে যান।',
      instructions: ['হাঁটার সময় সামনে আর পোষ্যর দিকে তাকান।', 'একই গতিতে হাঁটুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'வளர்ப்பு பிராணியை நடைக்கு அழைத்துப் போவது',
      description:
        'உங்கள் வளர்ப்பு பிராணியை குத்துக் கயிறு போட்டு வெளியே நடைக்கு அழைத்துச் செல்லுங்கள்.',
      instructions: [
    ...
    'mr-IN': {
      ...
      instructions: ['चालताना समोर आणि पाळीव प्राण्याकडे पाहा.', 'एकसारख्या गतीने चाला.'],
      examples: [],
    },
  },
  'Filling a bird feeder': {
    ...
    'pt-BR': {
      ...
      description:
        'Tire o comedouro de passarinho do lugar, coloque a ração dentro e pendure de volta.',
      instructions: ['Olhe para o comedouro enquanto enche.', 'Mova-se devagar e com firmeza.'],
      examples: [],
    },
    es: {
      name: 'Llenar un comedero para pájaros',
      description: 'Baja el comedero, echa semillas para pájaros dentro y vuelve a colgarlo.',
      instructions: ['Mira el comedero mientras lo llenas.', 'Muévete despacio y con paso firme.'],
      examples: [],
    },
    'hi-IN': {
      name: 'चिड़िया का दाना-पात्र भरना',
      description: 'बर्ड फ़ीडर को नीचे उतारें, उसमें दाना डालें, और वापस टाँग दें।',
      instructions: ['भरते समय फ़ीडर की ओर देखें।', 'धीरे और सँभलकर काम करें।'],
      examples: [],
    },
    'bn-IN': {
      name: 'পাখির খাবারের পাত্র ভরা',
      description: 'পাখির ফিডার নামিয়ে তাতে পাখির বীজ ভরুন, আর আবার ঝুলিয়ে দিন।',
      instructions: ['ভরার সময় ফিডারের দিকে তাকান।', 'আস্তে আর স্থিরভাবে নাড়ুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'பறவை உணவுக் கூண்டை நிரப்புவது',
      description:
        'பறவை உணவுக் கூண்டை கீழே இறக்கி, பறவை விதைகளை அதில் ஊற்றி, மீண்டும் தொங்கவிடுங்கள்.',
      instructions: ['நிரப்பும்போது உணவுக் கூண்டை பாருங்கள்.', 'மெதுவாக, நிலையாக நகருங்கள்.'],
      examples: [],
    },
    'te-IN': {
      name: 'పక్షుల ఆహార పాత్ర నింపడం',
      description: 'పక్షుల ఆహార పాత్రను దింపి, విత్తనాలు పోసి, తిరిగి వేలాడదీయండి.',
      instructions: ['నింపుతున్నప్పుడు పాత్ర వైపు చూడండి.', 'నెమ్మదిగా, స్థిరంగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'पक्ष्यांचा फीडर भरणे',
      description: 'पक्ष्यांचा फीडर खाली काढा, त्यात पक्ष्यांचे दाणे ओता आणि परत टांगा.',
      instructions: ['भरताना फीडरकडे पाहा.', 'हळूहळू आणि स्थिरपणे हालचाल करा.'],
      examples: [],
    },
  },
  'Picking up after a dog': {
    ...
    'pt-BR': {
      ...
      description:
        'Use uma sacola plástica para pegar o cocô do cachorro durante o passeio, amarre a sacola e leve até uma lixeira.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Usa una bolsa de plástico para recoger los desechos del perro durante el paseo, ata la bolsa y llévala a un bote de basura.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'घुमाने के दौरान प्लास्टिक की थैली से कुत्ते की गंदगी उठाएँ, थैली बाँधें, और कचरे के डिब्बे में डालें।',
      instructions: ['उठाते समय गंदगी की ओर नीचे देखें।', 'धीरे और सँभलकर काम करें।'],
      examples: [],
    },
    'bn-IN': {
      name: 'কুকুরের মল তুলে নেওয়া',
      description:
        'বেড়ানোর সময় প্লাস্টিকের ব্যাগ দিয়ে কুকুরের মল তুলুন, ব্যাগ বেঁধে আবর্জনার বিনে ফেলুন।',
      instructions: ['তোলার সময় মলের দিকে তাকান।', 'আস্তে আর স্থিরভাবে নাড়ুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'நாய் கழிவை எடுப்பது',
      description:
        'நடைக்கு அழைத்துச் செல்லும்போது, ஒரு பிளாஸ்டிக் பையை வைத்து நாய் கழிவை எடுத்து, பையை கட்டி, குப்பை தொட்டிக்கு கொண்டு செல்லவும்.',
      instructions: ['எடுக்கும்போது கழிவை கீழே பாருங்கள்.', 'மெதுவாக, நிலையாக நகருங்கள்.'],
      examples: [],
    },
    'te-IN': {
      name: 'కుక్క మలాన్ని తీయడం',
      description:
        'నడిచేటప్పుడు కుక్క మలాన్ని ప్లాస్టిక్ బ్యాగ్‌తో ఎత్తి, బ్యాగ్ ముడివేసి, చెత్త డబ్బాకు తీసుకెళ్లండి.',
      instructions: ['ఎత్తుతున్నప్పుడు మలం వైపు కిందికి చూడండి.', 'నెమ్మదిగా, స్థిరంగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'कुत्र्यानंतर साफ करणे',
      description:
        'फिरताना कुत्र्याची शी प्लास्टिकच्या पिशवीने उचला, पिशवी बांधा आणि कचराडब्यापर्यंत घेऊन जा.',
      instructions: ['उचलताना शीकडे खाली पाहा.', 'हळूहळू आणि स्थिरपणे हालचाल करा.'],
      examples: [],
    },
  },
  'Assembling furniture': {
    ...
    'pt-BR': {
      name: 'Montar móveis',
      description:
        'Junte as peças do móvel usando parafusos, cavilhas e ferramentas, seguindo o passo a passo.',
      instructions: [
    ...
    es: {
      name: 'Armar muebles',
      description:
        'Une las piezas del mueble usando tornillos, pernos y herramientas, siguiendo los pasos.',
      instructions: [
    ...
    'hi-IN': {
      ...
      instructions: ['काम करते समय अपने हाथों की ओर नीचे देखें।', 'काम करते रहें — रुकें नहीं।'],
      examples: [],
    },
    'bn-IN': {
      name: 'আসবাব জোড়া লাগানো',
      description: 'ধাপে ধাপে স্ক্রু, বল্টু আর যন্ত্রপাতি দিয়ে আসবাবের অংশগুলো জুড়ে লাগান।',
      instructions: ['কাজের সময় নিজের হাতের দিকে তাকান।', 'কাজ চালিয়ে যান — থামবেন না।'],
      examples: [],
    },
    'ta-IN': {
      name: 'மரச்சாமான்களை பொருத்துவது',
      description:
        'ஸ்க்ரூ, போல்ட் மற்றும் கருவிகளை வைத்து படிகளை பின்பற்றி மரச்சாமான் பாகங்களை இணைக்கவும்.',
      instructions: [
    ...
    'mr-IN': {
      ...
      instructions: ['काम करताना तुमच्या हातांकडे खाली पाहा.', 'काम चालू ठेवा — थांबू नका.'],
      examples: [],
    },
  },
  'Using hand tools (screwdriver, hammer, etc.)': {
    ...
    'pt-BR': {
      ...
      description:
        'Use ferramentas simples para consertar ou montar alguma coisa. Por exemplo, apertar parafusos com a chave de fenda ou bater pregos com o martelo.',
      instructions: [
        'Olhe para baixo, para as suas mãos, enquanto trabalha.',
    ...
    es: {
      ...
      description:
        'Usa herramientas sencillas para arreglar o construir algo. Por ejemplo, gira tornillos con un destornillador o clava clavos con un martillo.',
      instructions: [
        'Mira hacia abajo, a tus manos, mientras trabajas.',
    ...
    'hi-IN': {
      ...
      description:
        'कुछ ठीक करने या बनाने के लिए साधारण औज़ार इस्तेमाल करें। जैसे पेंचकस से पेंच कसना या हथौड़े से कील ठोकना।',
      instructions: ['काम करते समय अपने हाथों की ओर नीचे देखें।', 'हर काम के बीच धीरे-धीरे चलें।'],
      examples: [],
    },
    'bn-IN': {
      name: 'হাতের যন্ত্রপাতি ব্যবহার (স্ক্রুড্রাইভার, হাতুড়ি ইত্যাদি)',
      description:
        'সাধারণ যন্ত্র দিয়ে কিছু সারান বা বানান। যেমন স্ক্রুড্রাইভার দিয়ে স্ক্রু ঘোরান বা হাতুড়ি দিয়ে পেরেক ঠুকুন।',
      instructions: ['কাজের সময় নিজের হাতের দিকে তাকান।', 'কাজের মাঝে আস্তে এগোন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'கைக் கருவிகளை பயன்படுத்துவது (ஸ்க்ரூட்ரைவர், சுத்தியல் போன்றவை)',
      description:
        'ஏதேனும் ஒன்றை சரிசெய்யவோ உருவாக்கவோ எளிய கருவிகளை பயன்படுத்துங்கள். உதாரணமாக, ஸ்க்ரூட்ரைவர் வைத்து ஸ்க்ரூக்களை திருகுவது அல்லது சுத்தியலால் ஆணியை அடிப்பது.',
      instructions: [
        'வேலை செய்யும்போது உங்கள் கைகளை கீழே பாருங்கள்.',
    ...
    'te-IN': {
      ...
      description:
        'సాధారణ పరికరాలతో ఏదైనా బాగు చేయడం లేదా తయారు చేయడం. ఉదాహరణకు, స్క్రూడ్రైవర్‌తో స్క్రూలు తిప్పడం లేదా సుత్తితో మేకులు కొట్టడం.',
      instructions: [
        'పని చేస్తున్నప్పుడు మీ చేతుల వైపు కిందికి చూడండి.',
    ...
    'mr-IN': {
      ...
      description:
        'साधी हत्यारं वापरून काहीतरी दुरुस्त करा किंवा बनवा. उदाहरणार्थ, स्क्रूड्रायव्हरने स्क्रू फिरवा किंवा हातोड्याने खिळे ठोका.',
      instructions: ['काम करताना तुमच्या हातांकडे खाली पाहा.', 'क्रियांमध्ये हळूहळू हालचाल करा.'],
      examples: [],
    },
  },
  'Painting a wall or surface': {
    ...
    'pt-BR': {
      ...
      description:
        'Use um pincel ou rolo para passar a tinta por igual em uma parede ou superfície.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Usa una brocha o rodillo para aplicar pintura de forma pareja en una pared o superficie.',
      instructions: [
    ...
    'bn-IN': {
      ...
      instructions: ['যে অংশ রং করছেন সেদিকে তাকান।', 'একেকটা অংশে মসৃণভাবে এগোন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'சுவர் அல்லது மேற்பரப்பில் பெயிண்ட் அடிப்பது',
      description:
        'ஒரு பிரஷ் அல்லது ரோலரை வைத்து சுவர் அல்லது மேற்பரப்பில் பெயிண்டை சமமாக பூசவும்.',
      instructions: [
    ...
    'te-IN': {
      ...
      instructions: ['మీరు రంగు వేస్తున్న భాగం వైపు చూడండి.', 'సెక్షన్ల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
  ...
  'Minor plumbing repair': {
    ...
    'pt-BR': {
      ...
      description:
        'Conserte problemas pequenos como uma torneira pingando ou um cano solto usando ferramentas básicas.',
      instructions: [
        'Olhe para baixo, para as suas mãos, enquanto trabalha.',
        'Mova-se devagar entre as ações.',
      ],
    ...
    es: {
      ...
      description:
        'Arregla problemas pequeños como una llave que gotea o un caño suelto con herramientas básicas.',
      instructions: [
        'Mira hacia abajo, a tus manos, mientras trabajas.',
        'Muévete despacio entre las acciones.',
      ],
    ...
    'ta-IN': {
      ...
      description:
        'கசியும் குழாய் அல்லது தளர்வான பைப் போன்ற சிறிய பிரச்சினைகளை அடிப்படை கருவிகளை வைத்து சரிசெய்யவும்.',
      instructions: [
        'வேலை செய்யும்போது உங்கள் கைகளை கீழே பாருங்கள்.',
        'ஒரு செயலிலிருந்து இன்னொன்றுக்கு மெதுவாக நகருங்கள்.',
      ],
    ...
    'te-IN': {
      ...
      description:
        'లీక్ అవుతున్న కొళాయి లేదా వదులైన పైపు లాంటి చిన్న సమస్యలను సాధారణ పరికరాలతో బాగు చేయండి.',
      instructions: [
        'పని చేస్తున్నప్పుడు మీ చేతుల వైపు కిందికి చూడండి.',
        'ప్రతి చర్య మధ్య నెమ్మదిగా కదలండి.',
      ],
    ...
    'mr-IN': {
      ...
      description:
        'गळणारा नळ किंवा सैल पाइप यासारख्या छोट्या समस्या साध्या हत्यारांनी दुरुस्त करा.',
      instructions: ['काम करताना तुमच्या हातांकडे खाली पाहा.', 'क्रियांमध्ये हळूहळू हालचाल करा.'],
      examples: [],
    },
  },
  'Washing or cleaning a vehicle': {
    ...
    'pt-BR': {
      ...
      description:
        'Use água, sabão e um pano ou esponja para limpar a parte de fora de um carro, moto ou bicicleta.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Usa agua, jabón y un paño o esponja para limpiar el exterior de un auto, bici o moto.',
      instructions: [
    ...
    'bn-IN': {
      ...
      description:
        'জল, সাবান আর কাপড় বা স্পঞ্জ দিয়ে গাড়ি, বাইক বা স্কুটারের বাইরের অংশ পরিষ্কার করুন।',
      instructions: ['যে অংশ ধুচ্ছেন সেদিকে তাকান।', 'একেকটা অংশে মসৃণভাবে এগোন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'வாகனத்தை கழுவுவது அல்லது சுத்தம் செய்வது',
      description:
        'தண்ணீர், சோப்பு மற்றும் ஒரு துணி அல்லது ஸ்பாஞ்சை பயன்படுத்தி கார், பைக் அல்லது ஸ்கூட்டரின் வெளிப்பகுதியை சுத்தம் செய்யவும்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'నీళ్లు, సబ్బు, గుడ్డ లేదా స్పాంజ్‌తో కారు, బైక్ లేదా స్కూటర్ బయట భాగాన్ని శుభ్రం చేయండి.',
      instructions: ['మీరు కడుగుతున్న భాగం వైపు చూడండి.', 'సెక్షన్ల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'वाहन धुणे किंवा साफ करणे',
      description:
        'पाणी, साबण आणि कापड किंवा स्पंजने कार, बाइक किंवा स्कूटरचा बाहेरचा भाग साफ करा.',
      instructions: [
  ...
  'Replacing an air filter': {
    ...
    'pt-BR': {
      ...
      description:
        'Abra o encaixe do filtro de ar no aquecedor ou na grade de retorno, puxe o filtro velho e encaixe um filtro novo.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Abre el espacio del filtro de aire en la calefacción o la rejilla de retorno, saca el filtro viejo y mete uno nuevo.',
      instructions: [
    ...
    'hi-IN': {
      ...
      description:
        'फ़र्नेस या रिटर्न वेंट का एयर फ़िल्टर वाला ख़ाना खोलें, पुराना फ़िल्टर निकालें, और नया फ़िल्टर अंदर डालें।',
      instructions: ['काम करते समय फ़िल्टर के ख़ाने की ओर देखें।', 'हर कदम धीरे-धीरे बढ़ाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'এয়ার ফিল্টার বদলানো',
      description:
        'ফার্নেস বা রিটার্ন ভেন্টের এয়ার ফিল্টারের খাঁজ খুলে পুরোনো ফিল্টার বের করুন, আর নতুনটা ঢুকিয়ে দিন।',
      instructions: ['কাজের সময় ফিল্টারের খাঁজের দিকে তাকান।', 'ধাপগুলোর মাঝে আস্তে এগোন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'ஏர் ஃபில்டரை மாற்றுவது',
      description:
        'ஃபர்னேஸ் அல்லது ரிட்டர்ன் வெண்ட்டில் உள்ள ஏர் ஃபில்டர் இடத்தை திறந்து, பழைய ஃபில்டரை வெளியே இழுத்து, புதிய ஃபில்டரை உள்ளே நுழைக்கவும்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'ఫర్నేస్ లేదా రిటర్న్ వెంట్ మీద ఎయిర్ ఫిల్టర్ స్లాట్ తెరిచి, పాత ఫిల్టర్‌ను బయటకు తీసి, తాజా ఫిల్టర్‌ను లోపలికి జారనివ్వండి.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'फर्नेस किंवा रिटर्न व्हेंटमधील एअर फिल्टरचा खण उघडा, जुना फिल्टर बाहेर सरकवा आणि नवीन फिल्टर आत सरकवा.',
      instructions: ['काम करताना फिल्टरच्या खणाकडे पाहा.', 'टप्प्यांमध्ये हळूहळू हालचाल करा.'],
      examples: [],
    },
  },
  'Replacing a smoke detector battery': {
    ...
    'pt-BR': {
      ...
      description:
        'Abra o detector de fumaça, tire a pilha velha, coloque uma nova e feche a tampa.',
      instructions: ['Olhe para cima, para o detector.', 'Mova-se devagar entre as etapas.'],
      examples: [],
    },
    es: {
      ...
      instructions: ['Mira hacia arriba, al detector.', 'Muévete despacio entre los pasos.'],
      examples: [],
    },
    'hi-IN': {
      name: 'स्मोक डिटेक्टर की बैटरी बदलना',
      description: 'स्मोक डिटेक्टर खोलें, पुरानी बैटरी निकालें, नई बैटरी डालें, और कवर बंद करें।',
      instructions: ['डिटेक्टर की ओर ऊपर देखें।', 'हर कदम धीरे-धीरे बढ़ाएँ।'],
      examples: [],
    },
    'bn-IN': {
      name: 'স্মোক ডিটেক্টরের ব্যাটারি বদলানো',
      description:
        'স্মোক ডিটেক্টর খুলে পুরোনো ব্যাটারি বের করুন, নতুনটা লাগান, আর ঢাকনা বন্ধ করুন।',
      instructions: ['ডিটেক্টরের দিকে উপরে তাকান।', 'ধাপগুলোর মাঝে আস্তে এগোন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'புகை கண்டறிவான் பேட்டரியை மாற்றுவது',
      description:
        'புகை கண்டறிவானை திறந்து, பழைய பேட்டரியை எடுத்து, புதியதை வைத்து, மூடியை மூடவும்.',
      instructions: ['கண்டறிவானை மேலே பாருங்கள்.', 'ஒவ்வொரு படியிலும் மெதுவாக நகருங்கள்.'],
      examples: [],
    },
    'te-IN': {
      name: 'స్మోక్ డిటెక్టర్ బ్యాటరీ మార్చడం',
      description: 'స్మోక్ డిటెక్టర్ తెరిచి, పాత బ్యాటరీ తీసి, తాజాది వేసి, మూత మూయండి.',
      instructions: ['డిటెక్టర్ వైపు పైకి చూడండి.', 'ప్రతి అడుగు మధ్య నెమ్మదిగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'स्मोक डिटेक्टरची बॅटरी बदलणे',
      description: 'स्मोक डिटेक्टर उघडा, जुनी बॅटरी काढा, नवीन बॅटरी घाला आणि झाकण बंद करा.',
      instructions: ['डिटेक्टरकडे वर पाहा.', 'टप्प्यांमध्ये हळूहळू हालचाल करा.'],
      examples: [],
    },
  },
  'Changing a light bulb': {
    ...
    'pt-BR': {
      ...
      description:
        'Desligue a luz, desrosqueie a lâmpada velha do bocal e rosqueie uma lâmpada nova.',
      instructions: ['Olhe para cima, para o bocal.', 'Mova-se devagar e com firmeza.'],
      examples: [],
    },
    es: {
      name: 'Cambiar un foco',
      description: 'Apaga la luz, desenrosca el foco viejo y enrosca un foco nuevo.',
      instructions: ['Mira hacia arriba, a la lámpara.', 'Muévete despacio y con paso firme.'],
      examples: [],
    },
    'hi-IN': {
      name: 'बल्ब बदलना',
      description:
        'लाइट बंद करें, फ़िक्सचर से पुराना बल्ब घुमाकर निकालें, और नया बल्ब घुमाकर लगाएँ।',
      instructions: ['फ़िक्सचर की ओर ऊपर देखें।', 'धीरे और सँभलकर काम करें।'],
      examples: [],
    },
    'bn-IN': {
      name: 'বাল্ব বদলানো',
      description: 'লাইট বন্ধ করুন, হোল্ডার থেকে পুরোনো বাল্ব খুলুন, আর নতুন বাল্ব লাগান।',
      instructions: ['হোল্ডারের দিকে উপরে তাকান।', 'আস্তে আর স্থিরভাবে নাড়ুন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'லைட் பல்பை மாற்றுவது',
      description:
        'லைட்டை அணைத்துவிட்டு, பழைய பல்பை திருகி எடுத்து, புதிய பல்பை உள்ளே திருகி வையுங்கள்.',
      instructions: ['பல்ப் ஃபிக்ஸ்சரை மேலே பாருங்கள்.', 'மெதுவாக, நிலையாக நகருங்கள்.'],
      examples: [],
    },
    'te-IN': {
      name: 'లైట్ బల్బ్ మార్చడం',
      description:
        'లైట్ ఆపేసి, ఫిక్చర్ నుండి పాత బల్బ్‌ను తిప్పి తీసి, కొత్త బల్బ్ తిప్పి బిగించండి.',
      instructions: ['ఫిక్చర్ వైపు పైకి చూడండి.', 'నెమ్మదిగా, స్థిరంగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
      name: 'लाइट बल्ब बदलणे',
      description: 'लाइट बंद करा, फिक्श्चरमधून जुना बल्ब फिरवून काढा आणि नवीन बल्ब बसवा.',
      instructions: ['फिक्श्चरकडे वर पाहा.', 'हळूहळू आणि स्थिरपणे हालचाल करा.'],
      examples: [],
    },
  },
  'Sewing or mending clothes': {
    ...
    'ta-IN': {
      ...
      description:
        'ஊசி, நூல் வைத்து கிழிசலை சரிசெய்யவோ அல்லது துணி துண்டுகளை இணைத்து தைக்கவோ செய்யுங்கள்.',
      instructions: [
    ...
    'mr-IN': {
      ...
      description:
        'फाटलेले कपडे दुरुस्त करण्यासाठी किंवा कापडाचे तुकडे एकत्र शिवण्यासाठी सुई आणि दोरा वापरा.',
      instructions: [
        'स्थिर जागी बसा.',
  ...
  'Knitting or crocheting': {
    ...
    'pt-BR': {
      ...
      description:
        'Use agulhas ou agulha de crochê com lã para fazer tecidos, cachecóis ou outros itens.',
      instructions: [
        'Sente em um lugar firme.',
        'Olhe para baixo, para as suas mãos, enquanto trabalha.',
        'Continue trabalhando — não pare.',
    ...
    'ta-IN': {
      ...
      description:
        'ஊசி அல்லது கொக்கி வைத்து நூலால் துணி, ஸ்கார்ஃப் அல்லது மற்ற பொருட்களை பின்னுங்கள்.',
      instructions: [
        'ஒரு நிலையான இடத்தில் உட்காரவும்.',
        'வேலை செய்யும்போது உங்கள் கைகளை கீழே பாருங்கள்.',
        'வேலை செய்துகொண்டே இருங்கள் — நிறுத்த வேண்டாம்.',
    ...
    'te-IN': {
      ...
      description:
        'సూదులు లేదా హుక్‌తో ఉన్ని దారం ఉపయోగించి బట్ట, మఫ్లర్‌లు లేదా ఇతర వస్తువులు తయారు చేయండి.',
      instructions: [
        'స్థిరమైన చోట కూర్చోండి.',
        'పని చేస్తున్నప్పుడు మీ చేతుల వైపు కిందికి చూడండి.',
        'పని చేస్తూ ఉండండి — ఆగకండి.',
  ...
  'Gift wrapping': {
    ...
    'pt-BR': {
      ...
      description:
        'Embrulhe um presente com papel, dobre as pontas com capricho e cole fita adesiva ou amarre uma fita para fechar.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Envuelve un regalo en papel, dobla los bordes con cuidado y pega cinta o moño para sujetarlo.',
      instructions: [
    ...
    'bn-IN': {
      name: 'উপহার মোড়ানো',
      description:
        'কাগজ দিয়ে উপহার মুড়ুন, কোণাগুলো গুছিয়ে ভাঁজ করুন, আর টেপ বা ফিতে দিয়ে আটকে দিন।',
      instructions: ['মোড়ানোর সময় নিজের হাতের দিকে তাকান।', 'মাথা ছোট ছোট করে আস্তে ঘোরান।'],
      examples: [],
    },
    'ta-IN': {
      name: 'பரிசுப் பொருளை சுற்றுவது',
      description:
        'பரிசுப் பொருளை காகிதத்தில் சுற்றி, ஓரங்களை ஒழுங்காக மடித்து, டேப் அல்லது ரிப்பனால் கட்டிவையுங்கள்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'గిఫ్ట్‌ను కాగితంలో చుట్టి, అంచులు నీట్‌గా మడిచి, టేప్ లేదా రిబ్బన్‌తో పట్టి ఉంచండి.',
      instructions: [
  ...
  'Hanging holiday string lights': {
    ...
    'pt-BR': {
      ...
      description:
        'Desenrole um cordão de pisca-pisca e pendure no corrimão, no telhado ou em uma árvore.',
      instructions: [
    ...
    es: {
      ...
      description:
        'Desenreda una tira de luces y cuélgala a lo largo de un barandal, el borde del techo o un árbol.',
      instructions: [
    ...
    'bn-IN': {
      ...
      instructions: ['যেখানে আলো ঝোলাচ্ছেন সেদিকে তাকান।', 'একেকটা অংশে মসৃণভাবে এগোন।'],
      examples: [],
    },
    'ta-IN': {
      name: 'பண்டிகை அலங்கார விளக்குகளை தொங்கவிடுவது',
      description:
        'ஸ்ட்ரிங் விளக்குகளின் சுருளை அவிழ்த்து, கைப்பிடி, கூரை ஓரம் அல்லது மரத்தில் தொங்கவிடவும்.',
      instructions: [
    ...
    'te-IN': {
      ...
      description:
        'సీరియల్ లైట్ల చుట్టను విప్పి, రెయిలింగ్, పైకప్పు అంచు లేదా చెట్టు మీద వేలాడదీయండి.',
      instructions: ['మీరు లైట్లు వేలాడదీస్తున్న చోటును చూడండి.', 'సెక్షన్ల మధ్య మెల్లగా కదలండి.'],
      examples: [],
    },
    'mr-IN': {
...
// ─────────────────────────────────────────────────────────────────────────
// EN_TOKEN_ALIASES — G-13 closure (Plan 07-16 Task 3).
// ─────────────────────────────────────────────────────────────────────────
...
// "recyclable" / "recycle" / "recyclables" / "recycling" and all four hit
// "Sorting recyclables".
//
// Consumed by `reverseSearch.ts`'s en branch: each whitespace-token is
// rewritten via this map before forwarding to /tasks/search.
//
// Keep entries lowercase (the consumer lowercases the input token before
// lookup). Identity entries are optional but useful for making the
// canonical set explicit. Maintain this list when adding new canonical
// task names whose user-typed derivational forms differ from the indexed
// stem (a small curated table is more reliable than algorithmic stemming
// for the 86-task catalog, per plan 07-16 checker BLOCKER 4).
export const EN_TOKEN_ALIASES: Record<string, string> = {
  // recycling family — operator's G-13 escape (2026-05-26 hi-IN walk)

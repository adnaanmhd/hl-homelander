  ...
  const onUpdate = useCallback(async () => {
    ...
    try {
      ...
      if (msg === 'apk_hash_mismatch') {
        ...
        // inside startUpgrade.
        Alert.alert(t('forceUpgrade.alerts.integrityTitle'), t('forceUpgrade.alerts.integrityBody'));
      } else if (msg === 'apk_download_failed') {
        Alert.alert(t('forceUpgrade.alerts.failedTitle'), t('forceUpgrade.alerts.failedBodyNetwork'));
      } else {

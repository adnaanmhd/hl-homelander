// Plan 03-03 — Visual snapshot for HistoryPlaceholderScreen with the
...
//   - "History — coming in Phase 6." body copy
...
describe('HistoryPlaceholderScreen visual (Plan 03-03 Task 1 / Pattern 71)', () => {
  afterEach(() => cleanup());

  it('matches baseline (TopBar wordmark + Google avatar + body copy)', () => {
    const { container } = render(<HistoryPlaceholderScreen />);
